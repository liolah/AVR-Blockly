...
goog.DEPENDENCIES_ENABLED &&
  ...
  (goog.writeScripts_ = function () {
    ...
    for (f = 0; f < b.length; f++)
      if ((e = b[f]))
        d.pathIsModule[e]
          ? goog.importModule_(goog.basePath + e)
          : goog.importScript_(goog.basePath + e);
      else
...
goog.string.numerateCompare = function (a, b) {
  ...
  if (!b) return 1;
  for (
    var c = a.toLowerCase().match(goog.string.numerateCompareRegExp_),
      d = b.toLowerCase().match(goog.string.numerateCompareRegExp_),
    ...
    if (g != h)
      return (
        (c = parseInt(g, 10)),
        !isNaN(c) && ((d = parseInt(h, 10)), !isNaN(d) && c - d)
          ? c - d
          : g < h
          ? -1
          : 1
  ...
  for (
    ...
    do {
      ...
      var c = 0 == m[1].length ? 0 : parseInt(m[1], 10),
        n = 0 == p[1].length ? 0 : parseInt(p[1], 10),
        c =
          goog.string.compareElements_(c, n) ||
          goog.string.compareElements_(0 == m[2].length, 0 == p[2].length) ||
          goog.string.compareElements_(m[2], p[2]);
    } while (0 == c);
  }
  return c;
};
...
goog.array.lastIndexOf =
  ...
  (goog.array.ASSUME_NATIVE_FUNCTIONS ||
    ...
    ? function (a, b, c) {
        goog.asserts.assert(null != a.length);
        return goog.array.ARRAY_PROTOTYPE_.lastIndexOf.call(
          a,
          b,
          null == c ? a.length - 1 : c
        );
...
goog.array.slice = function (a, b, c) {
  ...
  return 2 >= arguments.length
    ? goog.array.ARRAY_PROTOTYPE_.slice.call(a, b)
    : goog.array.ARRAY_PROTOTYPE_.slice.call(a, b, c);
};
...
goog.array.rotate = function (a, b) {
  ...
  a.length &&
    ...
    0 < b
      ...
      : 0 > b && goog.array.ARRAY_PROTOTYPE_.push.apply(a, a.splice(0, -b)));
  return a;
};
...
goog.userAgent.determineVersion_ = function () {
  ...
  return goog.userAgent.IE &&
    ((b = goog.userAgent.getDocumentMode_()), b > parseFloat(a))
    ? String(b)
    : a;
};
...
goog.userAgent.isVersionOrHigher = function (a) {
  return (
    ...
    goog.userAgent.isVersionOrHigherCache_[a] ||
    (goog.userAgent.isVersionOrHigherCache_[a] =
    ...
    null != d &&
      (d instanceof goog.string.Const
        ? ((d = goog.string.Const.unwrap(d)),
          goog.asserts.assert(!/[{;}]/.test(d), "Value does not allow [{;}]."))
        ...
        : (goog.asserts.fail(
            "String value allows only [-,.\"'%_!# a-zA-Z0-9], got: " + d
          ),
          (d = goog.html.SafeStyle.INNOCUOUS_STRING)),
      (b += c + ":" + d + ";"));
  }
...
goog.i18n.bidi.guardBracketInHtml = function (a, b) {
  return (void 0 === b ? goog.i18n.bidi.hasAnyRtl(a) : b)
    ? a.replace(goog.i18n.bidi.bracketGuardHtmlRe_, "<span dir=rtl>$&</span>")
    : a.replace(goog.i18n.bidi.bracketGuardHtmlRe_, "<span dir=ltr>$&</span>");
};
...
goog.html.TrustedResourceUrl.unwrap = function (a) {
  ...
  goog.asserts.fail(
    "expected object of type TrustedResourceUrl, got '" + a + "'"
  );
  ...
  function (a, b, c) {
    ...
    if (b)
      for (var f in b) {
        ...
        var g = b[f];
        goog.isDefAndNotNull(g) &&
          (e += " " + goog.html.SafeHtml.getAttrNameAndValue_(a, f, g));
      }
...
goog.math.Coordinate.prototype.translate = function (a, b) {
  a instanceof goog.math.Coordinate
    ...
    : ((this.x += a), goog.isNumber(b) && (this.y += b));
  return this;
};
...
goog.dom.getElementByClass = function (a, b) {
  ...
  return (
    (d = c.getElementsByClassName
      ...
      ? c.querySelector("." + a)
      : goog.dom.getElementsByTagNameAndClass_(document, "*", a, b)[0]) || null
  );
};
...
goog.dom.createTable_ = function (a, b, c, d) {
  for (
    var e = a.createElement(goog.dom.TagName.TABLE),
      f = e.appendChild(a.createElement(goog.dom.TagName.TBODY)),
      g = 0;
    g < b;
    g++
  ) {
...
goog.dom.safeHtmlToNode_ = function (a, b) {
  ...
  goog.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT
    ? (goog.dom.safe.setInnerHtml(
        c,
        goog.html.SafeHtml.concat(goog.html.SafeHtml.create("br"), b)
      ),
...
goog.dom.getFrameContentWindow = function (a) {
  return (
    a.contentWindow || goog.dom.getWindow(goog.dom.getFrameContentDocument(a))
  );
};
...
goog.dom.nativelySupportsFocus_ = function (a) {
  return (
    a.tagName == goog.dom.TagName.A ||
    a.tagName == goog.dom.TagName.INPUT ||
    a.tagName == goog.dom.TagName.TEXTAREA ||
    a.tagName == goog.dom.TagName.SELECT ||
    a.tagName == goog.dom.TagName.BUTTON
  );
};
goog.dom.hasNonZeroBoundingRect_ = function (a) {
  a = goog.isFunction(a.getBoundingClientRect)
...
goog.math.Rect.prototype.contains = function (a) {
  return a instanceof goog.math.Rect
    ? this.left <= a.left &&
...
goog.math.Rect.prototype.translate = function (a, b) {
  a instanceof goog.math.Coordinate
    ...
    : ((this.left += a), goog.isNumber(b) && (this.top += b));
  return this;
};
...
goog.style.setPosition = function (a, b, c) {
  var d;
  b instanceof goog.math.Coordinate
    ? ((d = b.x), (b = b.y))
    : ((d = b), (b = c));
...
goog.style.getContainerOffsetToScrollInto = function (a, b, c) {
  ...
  var k = b.scrollLeft,
    l = b.scrollTop;
  if (
    b == goog.dom.getDocument().body ||
    b == goog.dom.getDocument().documentElement
  )
    (k = e.x + f.left),
      (l = e.y + f.top),
      goog.userAgent.IE &&
  ...
  c
    ? ((k += g - h / 2), (l += d - a / 2))
    : ((k += Math.min(g, Math.max(g - h, 0))),
      (l += Math.min(d, Math.max(d - a, 0))));
...
goog.style.getClientPosition = function (a) {
  ...
  var b = goog.isFunction(a.getBrowserEvent),
    c = a;
  a.targetTouches && a.targetTouches.length
    ? (c = a.targetTouches[0])
    : b &&
      a.getBrowserEvent().targetTouches &&
      a.getBrowserEvent().targetTouches.length &&
      (c = a.getBrowserEvent().targetTouches[0]);
...
goog.style.installStyles = function (a, b) {
  var c = goog.dom.getDomHelper(b),
    d = null,
    e = c.getDocument();
  goog.userAgent.IE && e.createStyleSheet
    ? ((d = e.createStyleSheet()), goog.style.setStyles(d, a))
    : ((e = c.getElementsByTagNameAndClass(goog.dom.TagName.HEAD)[0]),
      e ||
        ((d = c.getElementsByTagNameAndClass(goog.dom.TagName.BODY)[0]),
        (e = c.createDom(goog.dom.TagName.HEAD)),
        d.parentNode.insertBefore(e, d)),
      (d = c.createDom(goog.dom.TagName.STYLE)),
...
goog.style.getFontSize = function (a) {
  ...
  if (goog.userAgent.IE) {
    ...
    if (
      ...
      c in goog.style.CONVERTIBLE_RELATIVE_CSS_UNITS_
    )
      return (
        (a = a.parentNode),
...
goog.events.BrowserEvent.prototype.init = function (a, b) {
  ...
  d
    ? goog.userAgent.GECKO &&
      (goog.reflect.canAccessProperty(d, "nodeName") || (d = null))
    : c == goog.events.EventType.MOUSEOVER
    ? (d = a.fromElement)
    : c == goog.events.EventType.MOUSEOUT && (d = a.toElement);
...
goog.events.BrowserEvent.prototype.isButton = function (a) {
  return goog.events.BrowserFeature.HAS_W3C_BUTTON
    ...
    : !!(this.event_.button & goog.events.BrowserEvent.IEButtonMap[a]);
};
...
goog.events.unlistenByKey = function (a) {
  ...
  b.removeEventListener
    ...
    : b.detachEvent && b.detachEvent(goog.events.getOnString_(c), d);
  goog.events.listenerCountEstimate_--;
...
goog.events.EventTarget.dispatchEventInternal_ = function (a, b, c) {
  ...
  b.propagationStopped_ ||
    ((f = b.currentTarget = a),
    (e = f.fireListeners(d, !0, b) && e),
    b.propagationStopped_ || (e = f.fireListeners(d, !1, b) && e));
  if (c)
...
goog.Timer.callOnce = function (a, b, c) {
  ...
  return b > goog.Timer.MAX_TIMEOUT_
...
goog.a11y.aria.assertRoleIsSetInternalUtil = function (a, b) {
  if (
    !goog.array.contains(goog.a11y.aria.TAGS_WITH_ASSUMED_ROLES_, a.tagName)
  ) {
...
goog.events.KeyHandler.prototype.handleEvent = function (a) {
  var b = a.getBrowserEvent(),
    ...
    d,
    e = b.altKey;
  goog.userAgent.IE && a.type == goog.events.EventType.KEYPRESS
    ? ((c = this.keyCode_),
      (d =
        c != goog.events.KeyCodes.ENTER && c != goog.events.KeyCodes.ESC
          ? b.keyCode
          : 0))
    : (goog.userAgent.WEBKIT || goog.userAgent.EDGE) &&
    ...
    ? ((c = this.keyCode_),
      (d =
        0 <= b.charCode &&
        63232 > b.charCode &&
        goog.events.KeyCodes.isCharacterKey(c)
          ? b.charCode
          : 0))
    : goog.userAgent.OPERA && !goog.userAgent.WEBKIT
    ? ((c = this.keyCode_),
      (d = goog.events.KeyCodes.isCharacterKey(c) ? b.keyCode : 0))
    : ((c = b.keyCode || this.keyCode_),
      (d = b.charCode || 0),
      goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ && (e = this.altKey_),
      goog.userAgent.MAC &&
        d == goog.events.KeyCodes.QUESTION_MARK &&
        c == goog.events.KeyCodes.WIN_KEY &&
        (c = goog.events.KeyCodes.SLASH));
  var f = (c = goog.events.KeyCodes.normalizeKeyCode(c)),
    g = b.keyIdentifier;
  c
    ? 63232 <= c && c in goog.events.KeyHandler.safariKey_
      ? (f = goog.events.KeyHandler.safariKey_[c])
      : 25 == c && a.shiftKey && (f = 9)
    : g &&
      g in goog.events.KeyHandler.keyIdentifier_ &&
...
goog.ui.ContainerRenderer.prototype.createDom = function (a) {
  return a
    .getDomHelper()
    .createDom(goog.dom.TagName.DIV, this.getClassNames(a).join(" "));
};
...
goog.ui.Control.prototype.enableMouseEventHandling_ = function (a) {
  ...
  a
    ? (b
        .listen(c, goog.events.EventType.MOUSEOVER, this.handleMouseOver)
        .listen(c, goog.events.EventType.MOUSEDOWN, this.handleMouseDown)
        .listen(c, goog.events.EventType.MOUSEUP, this.handleMouseUp)
        .listen(c, goog.events.EventType.MOUSEOUT, this.handleMouseOut),
      this.handleContextMenu != goog.nullFunction &&
        b.listen(c, goog.events.EventType.CONTEXTMENU, this.handleContextMenu),
      goog.userAgent.IE &&
        (b.listen(c, goog.events.EventType.DBLCLICK, this.handleDblClick),
    ...
    : (b
        .unlisten(c, goog.events.EventType.MOUSEOVER, this.handleMouseOver)
      ...
      goog.userAgent.IE &&
        (b.unlisten(c, goog.events.EventType.DBLCLICK, this.handleDblClick),
  ...
  function (a) {
    if (this.clickExpected_) this.clickExpected_ = !1;
      ...
      var b = a.getBrowserEvent(),
        c = b.button,
        d = b.type;
      b.button = goog.events.BrowserEvent.MouseButton.LEFT;
      b.type = goog.events.EventType.MOUSEDOWN;
      this.control_.handleMouseDown(
        new goog.events.BrowserEvent(b, a.currentTarget)
      );
      b.type = goog.events.EventType.MOUSEUP;
...
goog.ui.Container.prototype.enterDocument = function () {
  ...
  this.getHandler()
    ...
    .listen(a, goog.events.EventType.MOUSEDOWN, this.handleMouseDown)
    .listen(
  ...
  c != this.hasCheckBoxStructure(b) &&
    ...
    c
      ? ((c = this.getCompositeCssClass_(
        ...
        b.insertBefore(
          a.getDomHelper().createDom(goog.dom.TagName.DIV, c),
          b.firstChild || null
        ))
...
goog.ui.MenuRenderer.prototype.getDecoratorForChild = function (a) {
  return a.tagName == goog.dom.TagName.HR
...
goog.dom.TagIterator.prototype.next = function () {
  ...
  if (this.started_) {
    ...
    if (this.tagType == b) {
      ...
      (c = this.reversed ? a.previousSibling : a.nextSibling)
        ? this.setPosition(c)
...
goog.dom.TagIterator.prototype.splice = function (a) {
  ...
  this.reversed = !this.reversed;
  for (
    var c = goog.isArrayLike(arguments[0]) ? arguments[0] : arguments,
      d = c.length - 1;
    0 <= d;
    d--
  )
...
goog.dom.NodeIterator.prototype.next = function () {
  do goog.dom.NodeIterator.superClass_.next.call(this);
  while (this.isEndTag());
  return this.node;
};
...
goog.ui.PaletteRenderer.prototype.createDom = function (a) {
  ...
  a = a
    ...
    .createDom(
      goog.dom.TagName.DIV,
      b ? b.join(" ") : null,
      this.createGrid(a.getContent(), a.getSize(), a.getDomHelper())
    );
...
goog.ui.PaletteRenderer.prototype.createTable = function (a, b) {
  var c = b.createDom(
    ...
    b.createDom(goog.dom.TagName.TBODY, this.getCssClass() + "-body", a)
  );
  c.cellSpacing = 0;
  c.cellPadding = 0;
  return c;
...
goog.ui.PaletteRenderer.prototype.findAriaLabelForCell_ = function (a) {
  ...
  for (var b = "", c; !b && (c = goog.iter.nextOrValue(a, null)); )
    c.nodeType == goog.dom.NodeType.ELEMENT &&
      (b = goog.a11y.aria.getLabel(c) || c.title);
  return b;
};
...
goog.ui.PaletteRenderer.prototype.setContent = function (a, b) {
  if (a) {
    var c = goog.dom.getElementsByTagNameAndClass(
    ...
    if (c) {
      ...
      if (d < b.length) {
        for (
          var e = [], f = goog.dom.getDomHelper(a), g = c.rows[0].cells.length;
          d < b.length;
...
goog.ui.PaletteRenderer.prototype.getContainingItem = function (a, b) {
  for (
    var c = a.getElement();
    b && b.nodeType == goog.dom.NodeType.ELEMENT && b != c;

  ) {
    if (
      b.tagName == goog.dom.TagName.TD &&
      goog.dom.classlist.contains(b, this.getCssClass() + "-cell")
    )
      return b.firstChild;
    b = b.parentNode;
  }
...
goog.ui.SelectionModel.prototype.removeItem = function (a) {
  a &&
    goog.array.remove(this.items_, a) &&
    a == this.selectedItem_ &&
...
goog.ui.SelectionModel.prototype.setSelectedItem = function (a) {
  a != this.selectedItem_ &&
    (this.selectItem_(this.selectedItem_, !1),
...
goog.ui.SelectionModel.prototype.selectItem_ = function (a, b) {
  a &&
    ("function" == typeof this.selectionHandler_
      ? this.selectionHandler_(a, b)
      : "function" == typeof a.setSelected && a.setSelected(b));
};
...
goog.ui.Palette.prototype.setContentInternal = function (a) {
  ...
  this.adjustSize_();
  this.selectionModel_
    ? (this.selectionModel_.clear(), this.selectionModel_.addItems(a))
    : ((this.selectionModel_ = new goog.ui.SelectionModel(a)),
      this.selectionModel_.setSelectionHandler(
        goog.bind(this.selectItem_, this)
      ),
...
goog.ui.Palette.prototype.handleMouseOver = function (a) {
  ...
  (b && a.relatedTarget && goog.dom.contains(b, a.relatedTarget)) ||
    (b != this.getHighlightedItem() && this.setHighlightedItem(b));
};
goog.ui.Palette.prototype.handleMouseDown = function (a) {
  goog.ui.Palette.superClass_.handleMouseDown.call(this, a);
  this.isActive() &&
    ((a = this.getRenderer().getContainingItem(this, a.target)),
...
goog.ui.Palette.prototype.performActionInternal = function (a) {
  ...
  return b
    ? (this.setSelectedItem(b),
      goog.ui.Palette.superClass_.performActionInternal.call(this, a))
    : !1;
};
...
goog.ui.Palette.prototype.setHighlightedIndex = function (a) {
  a != this.highlightedIndex_ &&
    (this.highlightIndex_(this.highlightedIndex_, !1),
...
goog.ui.Palette.prototype.highlightIndex_ = function (a, b) {
  if (this.getElement()) {
    ...
    if (c && 0 <= a && a < c.length) {
      ...
      this.currentCellControl_.getElement() != d &&
        this.currentCellControl_.setElementInternal(d);
      this.currentCellControl_.tryHighlight(b) &&
        this.getRenderer().highlightCell(this, c[a], b);
    }
  }
};
goog.ui.Palette.prototype.setHighlighted = function (a) {
  a && -1 == this.highlightedIndex_
    ? this.setHighlightedIndex(
        -1 < this.lastHighlightedIndex_ ? this.lastHighlightedIndex_ : 0
      )
    : a || this.setHighlightedIndex(-1);
...
goog.ui.Palette.prototype.adjustSize_ = function () {
  ...
  if (a)
    if (this.size_ && this.size_.width) {
      if (
        ((a = Math.ceil(a.length / this.size_.width)),
        !goog.isNumber(this.size_.height) || this.size_.height < a)
      )
        this.size_.height = a;
    } else
...
goog.ui.ColorPalette = function (a, b, c) {
  ...
  goog.ui.Palette.call(
    this,
    null,
    b || goog.ui.PaletteRenderer.getInstance(),
    c
  );
...
goog.ui.ColorPalette.prototype.getSelectedColor = function () {
  ...
  return a
    ? ((a = goog.style.getStyle(a, "background-color")),
      goog.ui.ColorPalette.parseColor_(a))
    : null;
};
goog.ui.ColorPalette.prototype.setSelectedColor = function (a) {
  a = goog.ui.ColorPalette.parseColor_(a);
  this.normalizedColors_ ||
    ...
    function (a, b) {
      ...
      c.title =
        this.labels_ && this.labels_[b]
          ? this.labels_[b]
          : "#" == a.charAt(0)
          ? "RGB (" + goog.color.hexToRgb(a).join(", ") + ")"
          : a;
      return c;
    },
    this
...
goog.ui.ColorPicker.prototype.setColors = function (a) {
  this.colorPalette_
    ? this.colorPalette_.setColors(a)
    : this.createColorPalette_(a);
};
...
goog.ui.ColorPicker.prototype.setFocusable = function (a) {
  this.focusable_ = a;
  this.colorPalette_ &&
    this.colorPalette_.setSupportedState(goog.ui.Component.State.FOCUSED, a);
};
...
goog.ui.ColorPicker.prototype.disposeInternal = function () {
  ...
  this.colorPalette_ &&
    (this.colorPalette_.dispose(), (this.colorPalette_ = null));
};
...
goog.structs.getCount = function (a) {
  return "function" == typeof a.getCount
    ? a.getCount()
...
goog.structs.contains = function (a, b) {
  return "function" == typeof a.contains
    ? a.contains(b)
    : "function" == typeof a.containsValue
    ? a.containsValue(b)
    : goog.isArrayLike(a) || goog.isString(a)
...
goog.structs.isEmpty = function (a) {
  return "function" == typeof a.isEmpty
    ? a.isEmpty()
    : goog.isArrayLike(a) || goog.isString(a)
...
goog.structs.Map.prototype.addAll = function (a) {
  var b;
  a instanceof goog.structs.Map
    ? ((b = a.getKeys()), (a = a.getValues()))
...
goog.debug.exposeExceptionAsHtml = function (a, b) {
  try {
    ...
    return goog.html.SafeHtml.concat(
      ...
      goog.html.SafeHtml.create("a", { href: d, target: "_new" }, c.fileName),
      goog.html.SafeHtml.htmlEscapePreservingNewlinesAndSpaces(
        "\nLine: " +
          c.lineNumber +
          "\n\nBrowser stack:\n" +
...
goog.debug.createViewSourceUrl_ = function (a) {
  ...
  return goog.html.uncheckedconversions.safeUrlFromStringKnownToSatisfyTypeContract(
    ...
    "view-source:" + goog.html.SafeUrl.unwrap(a)
  );
};
...
goog.debug.Logger.logToProfilers = function (a) {
  goog.global.console &&
    (goog.global.console.timeStamp
      ? goog.global.console.timeStamp(a)
      : goog.global.console.markTimeline &&
        goog.global.console.markTimeline(a));
...
goog.debug.Logger.prototype.doLogRecord_ = function (a) {
  ...
  else for (var b = 0, c; (c = goog.debug.Logger.rootHandlers_[b++]); ) c(a);
};
...
goog.ui.tree.BaseNode = function (a, b, c) {
  ...
  this.html_ =
    a instanceof goog.html.SafeHtml
      ? a
      : goog.html.legacyconversions.safeHtmlFromString(a);
};
...
goog.ui.tree.BaseNode.prototype.initAccessibility = function () {
  ...
  if (a) {
    ...
    (a = this.getExpandIconElement()) &&
      goog.a11y.aria.setRole(a, "presentation");
...
goog.ui.tree.BaseNode.prototype.removeChild = function (a, b) {
  ...
  if (c && (c.removeNode(this), this.isInDocument())) {
    ...
    this.hasChildren() ||
      ((c.style.display = "none"), this.updateExpandIcon(), this.updateIcon_());
  }
  return a;
};
...
goog.ui.tree.BaseNode.prototype.getRowSafeHtml = function () {
  ...
  var a = { class: this.getRowClassName(), style: a },
    b = [
...
goog.ui.tree.TypeAhead.prototype.selectMatchingNode_ = function (a) {
  var b;
  a &&
    (this.matchingNodeIndex_ < a.length &&
      ((b = a[this.matchingNodeIndex_]), (this.matchingNodes_ = a)),
    b && (b.reveal(), b.select()));
  return !!b;
};
...
goog.ui.tree.TreeControl.prototype.logger_ = goog.log.getLogger(
  ...
  if (d.imports && d.imports.length)
    ...
    if (h && h.length)
      for (var f = 0, g = h.length, k; f < g; f++)
        (k = h[f]),
          k.styleSheet &&
            goog.array.extend(c, goog.cssom.getAllCssStyleSheets(k.styleSheet));
  }
...
goog.cssom.getParentStyleSheet = function (a) {
  return (
    a.parentStyleSheet || (a.style && a.style["-closure-parent-stylesheet"])
  );
};
goog.cssom.replaceCssRule = function (a, b, c, d) {
  if ((c = c || goog.cssom.getParentStyleSheet(a)))
    if (
      ((a = 0 <= d ? d : goog.cssom.getCssRuleIndexInParentStyleSheet(a, c)),
      0 <= a)
    )
...
goog.cssom.addCssRule = function (a, b, c) {
  if (0 > c || void 0 == c) c = goog.cssom.getCssRulesFromStyleSheet(a).length;
  if (a.insertRule) a.insertRule(b, c);
  else if (((b = /^([^\{]+)\{([^\{]+)\}/.exec(b)), 3 == b.length))
    a.addRule(b[1], b[2], c);
...
goog.cssom.addCssText = function (a, b) {
  ...
  d.styleSheet
    ...
    : ((c = c.createTextNode(a)), d.appendChild(c));
  return d;
};
...
goog.cssom.getAllCss_ = function (a, b) {
  for (
    var c = [], d = goog.cssom.getAllCssStyleSheets(a), e = 0;
    (a = d[e]);
    e++
  ) {
    ...
    if (f && f.length) {
      ...
      for (var h = 0, k = f.length, l; h < k; h++)
        (l = f[h]),
          b && !l.href
            ? ((l = goog.cssom.getCssTextFromCssRule(l)), c.push(l))
            : l.href ||
              (l.style &&
                (l.parentStyleSheet ||
                  (l.style["-closure-parent-stylesheet"] = a),
                (l.style["-closure-rule-index"] = g)),
              c.push(l)),
          b || g++;
    }
  }
...
Blockly.Blocks.genUid = function () {
  var a = (++Blockly.Blocks.uidCounter_).toString();
...
Blockly.Bubble = function (a, b, c, d, e, f, g) {
  ...
  (f && g) ||
    ...
    (f = b.width + 2 * Blockly.Bubble.BORDER_WIDTH),
    (g = b.height + 2 * Blockly.Bubble.BORDER_WIDTH));
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
  ...
  var c = { filter: "url(#blocklyEmboss)" };
  ...
  this.bubbleBack_ = Blockly.createSvgElement(
    "rect",
    {
  ...
  b
    ? ((this.resizeGroup_ = Blockly.createSvgElement(
        "g",
...
Blockly.Bubble.prototype.bubbleMouseDown_ = function (a) {
  ...
  Blockly.isRightButton(a)
    ? a.stopPropagation()
    : Blockly.isTargetInput_(a) ||
      (Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED),
      (this.dragDeltaX = this.workspace_.RTL
        ? this.relativeLeft_ + a.clientX
        : this.relativeLeft_ - a.clientX),
      (this.dragDeltaY = this.relativeTop_ - a.clientY),
...
Blockly.Bubble.prototype.resizeMouseDown_ = function (a) {
  ...
  Blockly.isRightButton(a) ||
    (Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED),
    (this.resizeDeltaWidth = this.workspace_.RTL
      ? this.width_ + a.clientX
      : this.width_ - a.clientX),
    (this.resizeDeltaHeight = this.height_ - a.clientY),
    (Blockly.Bubble.onMouseUpWrapper_ = Blockly.bindEvent_(
      document,
      "mouseup",
      this,
...
Blockly.Bubble.prototype.resizeMouseMove_ = function (a) {
  ...
  var b = this.resizeDeltaWidth,
    ...
    b = this.workspace_.RTL ? b - a.clientX : b + a.clientX;
...
Blockly.Bubble.prototype.layoutBubble_ = function () {
  ...
  this.workspace_.RTL
    ? this.anchorX_ - c.viewLeft - a - this.width_ <
      ...
      ? (a =
          ...
          this.width_ -
          Blockly.Scrollbar.scrollbarThickness)
      : this.anchorX_ - c.viewLeft - a > c.viewWidth &&
        (a = this.anchorX_ - c.viewLeft - c.viewWidth)
    : this.anchorX_ + a < c.viewLeft
    ? (a = c.viewLeft - this.anchorX_)
    : c.viewLeft + c.viewWidth <
        this.anchorX_ +
          a +
          this.width_ +
...
Blockly.Bubble.prototype.positionBubble_ = function () {
  this.bubbleGroup_.setAttribute(
    ...
    "translate(" +
      (this.workspace_.RTL
        ? this.anchorX_ - this.relativeLeft_ - this.width_
        : this.anchorX_ + this.relativeLeft_) +
      ", " +
      (this.relativeTop_ + this.anchorY_) +
      ")"
  );
};
...
Blockly.Bubble.prototype.renderArrow_ = function () {
  ...
  if (b == d && c == e) a.push("M " + b + "," + c);
    ...
    var k = Math.sin(h),
      l = Math.cos(h),
      q = this.getBubbleSize(),
      h = (q.width + q.height) / Blockly.Bubble.ARROW_THICKNESS,
      h = Math.min(h, q.width, q.height) / 2,
      q = 1 - Blockly.Bubble.ANCHOR_RADIUS / f,
      d = b + q * d,
      e = c + q * e,
      q = b + h * l,
      m = c + h * k,
...
Blockly.Icon.prototype.createIcon = function () {
  this.iconGroup_ ||
    ((this.iconGroup_ = Blockly.createSvgElement(
      "g",
    ...
    Blockly.createSvgElement(
      ...
      this.iconGroup_
    ).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", this.png_),
...
Blockly.Icon.prototype.updateEditable = function () {
  this.block_.isInFlyout || !this.block_.isEditable()
    ? Blockly.addClass_(this.iconGroup_, "blocklyIconGroupReadonly")
    : Blockly.removeClass_(this.iconGroup_, "blocklyIconGroupReadonly");
};
...
Blockly.Comment.prototype.createEditor_ = function () {
  this.foreignObject_ = Blockly.createSvgElement(
    "foreignObject",
...
Blockly.Connection = function (a, b) {
  ...
  this.type = b;
  this.y_ = this.x_ = 0;
  this.dbList_ = a.workspace.connectionDBList;
...
Blockly.Connection.prototype.dispose = function () {
  ...
  Blockly.highlightedConnection_ == this &&
...
Blockly.Connection.prototype.connect = function (a) {
  ...
  if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
    ...
    if (a.targetConnection) {
      ...
      for (
        var c = this.sourceBlock_;
        (c = Blockly.Connection.singleConnection_(c, b));
    ...
    if (a.targetConnection) {
      ...
      for (c = this.sourceBlock_; c.nextConnection; )
        if (c.nextConnection.targetConnection) c = c.getNextBlock();
          ...
          b.previousConnection.checkType_(c.nextConnection) &&
            (c.nextConnection.connect(b.previousConnection), (b = null));
          break;
        }
      b &&
        setTimeout(function () {
  ...
  var d;
  this.isSuperior()
    ? ((c = this.sourceBlock_), (d = a.sourceBlock_))
    : ((c = a.sourceBlock_), (d = this.sourceBlock_));
...
Blockly.Connection.prototype.disconnect = function () {
  ...
  var b;
  this.isSuperior()
    ? ((b = this.sourceBlock_), (a = a.sourceBlock_))
    : ((b = a.sourceBlock_), (a = this.sourceBlock_));
  b.rendered && b.render();
  a.rendered && (a.updateDisabled(), a.render());
};
...
Blockly.Connection.prototype.moveTo = function (a, b) {
  ...
  this.x_ = a;
  this.y_ = b;
  this.hidden_ || this.dbList_[this.type].addConnection_(this);
};
  ...
  this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE
    ? ((a = this.sourceBlock_.RTL
      ...
      (a =
        ...
        ",7.5 v 5"))
    : (a = this.sourceBlock_.RTL
        ? "m 20,0 h -5 " + Blockly.BlockSvg.NOTCH_PATH_RIGHT + " h -5"
...
Blockly.Connection.prototype.closest = function (a, b, c) {
  function d(b) {
    var c = e[b];
    if (
      ((c.type == Blockly.OUTPUT_VALUE ||
        c.type == Blockly.PREVIOUS_STATEMENT) &&
        c.targetConnection) ||
      (c.type == Blockly.INPUT_VALUE &&
        c.targetConnection &&
        !c.targetBlock().isMovable()) ||
      !q.checkType_(c)
    )
      return !0;
    c = c.sourceBlock_;
  ...
  if (this.targetConnection) return { connection: null, radius: a };
...
Blockly.Connection.prototype.checkType_ = function (a) {
  ...
  if (
    (b && !b.isMovable() && !this.sourceBlock_.isMovable()) ||
    ((b = a.targetBlock()) && !b.isMovable() && !a.sourceBlock_.isMovable())
  )
    return !1;
...
Blockly.Connection.prototype.neighbours_ = function (a) {
  ...
  for (
    var c = this.dbList_[Blockly.OPPOSITE_TYPE[this.type]],
      d = this.x_,
      e = this.y_,
      f = 0,
      g = c.length - 2,
...
Blockly.Connection.prototype.setHidden = function (a) {
  (this.hidden_ = a) && this.inDB_
    ...
    : a || this.inDB_ || this.dbList_[this.type].addConnection_(this);
};
Blockly.Connection.prototype.hideAll = function () {
  this.setHidden(!0);
  if (this.targetConnection)
    for (
      var a = this.targetBlock().getDescendants(), b = 0;
      b < a.length;
      b++
    ) {
...
Blockly.Field.prototype.clone = function () {
  goog.asserts.fail(
    "There should never be an instance of Field, only its derived classes."
  );
};
Blockly.Field.NBSP = "\u00a0";
...
Blockly.Field.prototype.dispose = function () {
  this.mouseUpWrapper_ &&
    (Blockly.unbindEvent_(this.mouseUpWrapper_), (this.mouseUpWrapper_ = null));
...
Blockly.Field.prototype.render_ = function () {
  if (this.visible_ && this.textElement_) {
    try {
      ...
      a = 8 * this.textElement_.textContent.length;
    }
    this.borderRect_ &&
...
Blockly.Tooltip.onMouseMove_ = function (a) {
  if (
    ...
    if (Blockly.Tooltip.visible) {
      ...
      Math.sqrt(
        Math.pow(Blockly.Tooltip.lastX_ - a.clientX, 2) + Math.pow(b, 2)
      ) > Blockly.Tooltip.RADIUS_OK && Blockly.Tooltip.hide();
    } else
      Blockly.Tooltip.poisonedElement_ != Blockly.Tooltip.element_ &&
        (clearTimeout(Blockly.Tooltip.showPid_),
        (Blockly.Tooltip.lastX_ = a.clientX),
        (Blockly.Tooltip.lastY_ = a.clientY),
...
Blockly.Tooltip.show_ = function () {
  ...
  if (Blockly.Tooltip.DIV) {
    ...
    for (
      var a = Blockly.Tooltip.wrap_(a, Blockly.Tooltip.LIMIT),
        a = a.split("\n"),
        b = 0;
      b < a.length;
      b++
    ...
    var c = Blockly.Tooltip.lastX_,
      c = a
        ? c - (Blockly.Tooltip.OFFSET_X + Blockly.Tooltip.DIV.offsetWidth)
        : c + Blockly.Tooltip.OFFSET_X,
      d = Blockly.Tooltip.lastY_ + Blockly.Tooltip.OFFSET_Y;
    d + Blockly.Tooltip.DIV.offsetHeight > b.height &&
      (d -= Blockly.Tooltip.DIV.offsetHeight + 2 * Blockly.Tooltip.OFFSET_Y);
    a
      ? (c = Math.max(Blockly.Tooltip.MARGINS, c))
      : c + Blockly.Tooltip.DIV.offsetWidth >
          b.width - 2 * Blockly.Tooltip.MARGINS &&
        (c =
          b.width -
...
Blockly.Tooltip.wrap_ = function (a, b) {
  ...
  do {
    e = d;
    f = a;
    for (var h = [], k = c.length / g, l = 1, d = 0; d < c.length - 1; d++)
...
Blockly.Tooltip.wrapMutate_ = function (a, b, c) {
  for (
    var d = Blockly.Tooltip.wrapScore_(a, b, c), e, f = 0;
    f < b.length - 1;
    f++
  )
    if (b[f] != b[f + 1]) {
...
Blockly.Input.prototype.init = function () {
  if (this.sourceBlock_.workspace.rendered)
    for (var a = 0; a < this.fieldRow.length; a++)
      this.fieldRow[a].init(this.sourceBlock_);
};
...
Blockly.ScrollbarPair = function (a) {
  ...
  this.corner_ = Blockly.createSvgElement(
    "rect",
    {
...
Blockly.Scrollbar = function (a, b, c) {
  ...
  this.onMouseDownBarWrapper_ = Blockly.bindEvent_(
    this.svgBackground_,
    "mousedown",
    this,
    this.onMouseDownBar_
  );
  this.onMouseDownKnobWrapper_ = Blockly.bindEvent_(
    this.svgKnob_,
    "mousedown",
    this,
    this.onMouseDownKnob_
  );
};
...
Blockly.Scrollbar.prototype.resize = function (a) {
  ...
  if (this.horizontal_) {
    ...
    this.pair_
      ...
      : this.setVisible(b < a.contentHeight);
    this.ratio_ = b / a.contentWidth;
    if (
      -Infinity === this.ratio_ ||
      Infinity === this.ratio_ ||
      isNaN(this.ratio_)
    )
      this.ratio_ = 0;
    ...
    this.xCoordinate = a.absoluteLeft + 0.5;
    this.pair_ &&
      this.workspace_.RTL &&
      (this.xCoordinate +=
        a.absoluteLeft + Blockly.Scrollbar.scrollbarThickness);
    this.yCoordinate =
    ...
    this.workspace_.RTL ||
      (this.xCoordinate +=
        a.viewWidth - Blockly.Scrollbar.scrollbarThickness - 1);
    this.yCoordinate = a.absoluteTop + 0.5;
    this.svgGroup_.setAttribute(
      "transform",
      "translate(" + this.xCoordinate + ", " + this.yCoordinate + ")"
    );
...
Blockly.Scrollbar.prototype.createDom_ = function () {
  ...
  this.svgKnob_ = Blockly.createSvgElement(
    "rect",
    { class: "blocklyScrollbarKnob", rx: a, ry: a },
    this.svgGroup_
  );
  Blockly.Scrollbar.insertAfter_(
    this.svgGroup_,
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function (a) {
  ...
  if (!Blockly.isRightButton(a)) {
    var b = Blockly.mouseToSvg(a, this.workspace_.options.svg),
    ...
    b <= c ? (e -= f) : b >= c + d && (e += f);
    this.svgKnob_.setAttribute(
      this.horizontal_ ? "x" : "y",
      this.constrainKnob_(e)
    );
    this.onScroll_();
  }
  a.stopPropagation();
...
Blockly.Scrollbar.prototype.onMouseDownKnob_ = function (a) {
  ...
  Blockly.isRightButton(a) ||
    ...
    (Blockly.Scrollbar.onMouseUpWrapper_ = Blockly.bindEvent_(
      document,
      "mouseup",
      this,
      this.onMouseUpKnob_
    )),
    (Blockly.Scrollbar.onMouseMoveWrapper_ = Blockly.bindEvent_(
      document,
      "mousemove",
      this,
      this.onMouseMoveKnob_
    )));
  a.stopPropagation();
};
Blockly.Scrollbar.prototype.onMouseMoveKnob_ = function (a) {
  this.svgKnob_.setAttribute(
    ...
    this.constrainKnob_(
      this.startDragKnob +
        ((this.horizontal_ ? a.clientX : a.clientY) - this.startDragMouse)
    )
  );
  this.onScroll_();
};
...
Blockly.Trashcan.prototype.createDom = function () {
  ...
  this.svgLid_ = Blockly.createSvgElement(
    "image",
    {
      width: Blockly.SPRITE.width,
      height: Blockly.SPRITE.height,
...
Blockly.Trashcan.prototype.dispose = function () {
  this.svgGroup_ &&
    (goog.dom.removeNode(this.svgGroup_), (this.svgGroup_ = null));
...
Blockly.Trashcan.prototype.position = function () {
  var a = this.workspace_.getMetrics();
  a &&
    ((this.left_ = this.workspace_.RTL
      ? this.MARGIN_SIDE_
      : a.viewWidth + a.absoluteLeft - this.WIDTH_ - this.MARGIN_SIDE_),
    (this.top_ =
      a.viewHeight +
      a.absoluteTop -
...
Blockly.Trashcan.prototype.getRect = function () {
  ...
  return new goog.math.Rect(
    a.x - this.MARGIN_HOTSPOT_,
    a.y - this.MARGIN_HOTSPOT_,
...
Blockly.Trashcan.prototype.setOpen_ = function (a) {
  this.isOpen != a &&
    (goog.Timer.clear(this.lidTask_), (this.isOpen = a), this.animateLid_());
};
Blockly.Trashcan.prototype.animateLid_ = function () {
  ...
  a = goog.math.lerp(0.4, 0.8, this.lidOpen_);
...
Blockly.Xml.workspaceToDom = function (a) {
  ...
  a.RTL && (b = a.getWidth());
  for (
    var c = goog.dom.createDom("xml"), d = a.getTopBlocks(!0), e = 0, f;
    (f = d[e]);
    e++
  ) {
...
Blockly.Xml.blockToDom_ = function (a) {
  ...
  if ((c = a.getCommentText()))
    (c = goog.dom.createDom("comment", null, c)),
      "object" == typeof a.comment &&
        (c.setAttribute("pinned", a.comment.isVisible()),
        (d = a.comment.getBubbleSize()),
        c.setAttribute("h", d.height),
        c.setAttribute("w", d.width)),
      b.appendChild(c);
  a.data && ((c = goog.dom.createDom("data", null, a.data)), b.appendChild(c));
  for (c = 0; (d = a.inputList[c]); c++) {
    var h,
      e = !0;
    d.type != Blockly.DUMMY_INPUT &&
      ((f = d.connection.targetBlock()),
      d.type == Blockly.INPUT_VALUE
        ? (h = goog.dom.createDom("value"))
        : d.type == Blockly.NEXT_STATEMENT &&
          (h = goog.dom.createDom("statement")),
      f && (h.appendChild(Blockly.Xml.blockToDom_(f)), (e = !1)),
      h.setAttribute("name", d.name),
      e || b.appendChild(h));
  }
  a.inputsInlineDefault != a.inputsInline &&
    b.setAttribute("inline", a.inputsInline);
  ...
  if ((a = a.getNextBlock()))
    (h = goog.dom.createDom("next", null, Blockly.Xml.blockToDom_(a))),
      b.appendChild(h);
  return b;
};
...
Blockly.Xml.textToDom = function (a) {
  ...
  if (
    !a ||
    !a.firstChild ||
    "xml" != a.firstChild.nodeName.toLowerCase() ||
...
Blockly.Xml.domToWorkspace = function (a, b) {
  ...
  for (var d = b.childNodes.length, e = 0; e < d; e++) {
    ...
    if ("block" == f.nodeName.toLowerCase()) {
      var g = Blockly.Xml.domToBlock(a, f),
        h = parseInt(f.getAttribute("x"), 10),
...
Blockly.Xml.domToBlock = function (a, b, c) {
  var d = Blockly.Xml.domToBlockHeadless_(a, b, c);
  if (a.rendered) {
    d.setConnectionsHidden(!0);
    a = d.getDescendants();
    for (b = a.length - 1; 0 <= b; b--) a[b].initSvg();
    for (b = a.length - 1; 0 <= b; b--) a[b].render(!1);
    setTimeout(function () {
      d.setConnectionsHidden(!1);
    }, 1);
    d.updateDisabled();
...
Blockly.Xml.domToBlockHeadless_ = function (a, b, c) {
  var d = null,
  ...
  for (var g = null, f = 0, h; (h = b.childNodes[f]); f++)
    if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
      for (var g = null, k = 0, l; (l = h.childNodes[k]); k++)
        (3 == l.nodeType && l.data.match(/^\s*$/)) || (g = l);
      k = h.getAttribute("name");
      switch (h.nodeName.toLowerCase()) {
        case "mutation":
          d.domToMutation && (d.domToMutation(h), d.initSvg && d.initSvg());
          break;
        case "comment":
          d.setCommentText(h.textContent);
          var q = h.getAttribute("pinned");
          q &&
            setTimeout(function () {
              d.comment &&
                d.comment.setVisible &&
                d.comment.setVisible("true" == q);
            }, 1);
          ...
          !isNaN(g) &&
            ...
            d.comment &&
            d.comment.setVisible &&
            d.comment.setBubbleSize(g, h);
          break;
        case "data":
          d.data = h.textContent;
          break;
        case "title":
        case "field":
        ...
        case "statement":
          ...
          if (g && "block" == g.nodeName.toLowerCase())
            if (
              ((g = Blockly.Xml.domToBlockHeadless_(a, g, c)),
              g.outputConnection)
            )
              h.connection.connect(g.outputConnection);
            else if (g.previousConnection)
              h.connection.connect(g.previousConnection);
            else
        ...
        case "next":
          if (g && "block" == g.nodeName.toLowerCase()) {
            ...
            if (d.nextConnection.targetConnection)
          ...
          break;
        default:
          console.log("Ignoring unknown tag: " + h.nodeName);
      }
    }
  (a = b.getAttribute("inline")) && d.setInputsInline("true" == a);
  (a = b.getAttribute("disabled")) && d.setDisabled("true" == a);
  (a = b.getAttribute("deletable")) && d.setDeletable("true" == a);
  (a = b.getAttribute("movable")) && d.setMovable("true" == a);
  (a = b.getAttribute("editable")) && d.setEditable("true" == a);
  (b = b.getAttribute("collapsed")) && d.setCollapsed("true" == b);
  return d;
};
...
Blockly.WorkspaceSvg.prototype.createDom = function (a) {
  ...
  this.svgBlockCanvas_ = Blockly.createSvgElement(
    "g",
    { class: "blocklyBlockCanvas" },
    this.svgGroup_
  );
  this.svgBubbleCanvas_ = Blockly.createSvgElement(
    "g",
    { class: "blocklyBubbleCanvas" },
    this.svgGroup_
  );
  this.options.hasTrashcan && this.addTrashcan_();
  ...
  this.options.hasCategories
    ...
    : this.options.languageTree && this.addFlyout_();
  return this.svgGroup_;
};
Blockly.WorkspaceSvg.prototype.dispose = function () {
  ...
  this.options.parentWorkspace || goog.dom.removeNode(this.options.svg);
};
...
Blockly.WorkspaceSvg.prototype.addFlyout_ = function () {
  this.flyout_ = new Blockly.Flyout({ parentWorkspace: this, RTL: this.RTL });
...
Blockly.WorkspaceSvg.prototype.traceOn = function (a) {
  this.traceOn_ = a;
  this.traceWrapper_ &&
    (Blockly.unbindEvent_(this.traceWrapper_), (this.traceWrapper_ = null));
  a &&
    (this.traceWrapper_ = Blockly.bindEvent_(
    ...
    if (!isNaN(c) && !isNaN(a)) {
      ...
      do {
        for (var d = !1, e = this.getAllBlocks(), f = 0, g; (g = e[f]); f++)
          if (
            ((g = g.getRelativeToSurfaceXY()),
            1 >= Math.abs(c - g.x) && 1 >= Math.abs(a - g.y))
          ) {
            d = !0;
            break;
          }
        if (!d)
          for (e = b.getConnections_(!1), f = 0; (g = e[f]); f++)
            if (g.closest(Blockly.SNAP_RADIUS, c, a).connection) {
              d = !0;
              break;
            }
        d &&
          ((c = this.RTL ? c - Blockly.SNAP_RADIUS : c + Blockly.SNAP_RADIUS),
          (a += 2 * Blockly.SNAP_RADIUS));
      } while (d);
      b.moveBy(c, a);
    }
    b.select();
...
Blockly.WorkspaceSvg.prototype.isDeleteArea = function (a) {
  ...
  if (this.deleteAreaToolbox_ && this.deleteAreaToolbox_.contains(a))
    return Blockly.Css.setCursor(Blockly.Css.Cursor.DELETE), !0;
  Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED);
  return !1;
};
Blockly.WorkspaceSvg.prototype.onMouseDown_ = function (a) {
  ...
  Blockly.isTargetInput_(a) ||
    ...
    a.target &&
      a.target.nodeName &&
      ("svg" == a.target.nodeName.toLowerCase() ||
        a.target == this.svgBackground_) &&
      Blockly.selected &&
    ...
    Blockly.isRightButton(a)
      ...
      : this.scrollbar &&
        ...
        "mouseup" in Blockly.bindEvent_.TOUCH_MAP &&
          (Blockly.onTouchUpWrapper_ = Blockly.bindEvent_(
            document,
            "mouseup",
            null,
            Blockly.onMouseUp_
          )),
        (Blockly.onMouseMoveWrapper_ = Blockly.bindEvent_(
          document,
          "mousemove",
          null,
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
  if (!this.options.readOnly) {
    ...
    if (this.options.collapse) {
      for (
        var c = !1, d = !1, e = this.getTopBlocks(!1), f = 0;
        f < e.length;
        f++
      )
        for (var g = e[f]; g; )
      ...
      d.callback = function () {
        for (var a = 0, b = 0; b < e.length; b++)
          for (var c = e[b]; c; )
            setTimeout(c.setCollapsed.bind(c, !0), a),
              (c = c.getNextBlock()),
              (a += 10);
      };
      b.push(d);
      ...
      c.callback = function () {
        for (var a = 0, b = 0; b < e.length; b++)
          for (var c = e[b]; c; )
            setTimeout(c.setCollapsed.bind(c, !1), a),
              (c = c.getNextBlock()),
              (a += 10);
      };
      b.push(c);
...
Blockly.WorkspaceSvg.prototype.playAudio = function (a, b) {
  ...
  c
    ? ((c =
        (goog.userAgent.DOCUMENT_MODE && 9 === goog.userAgent.DOCUMENT_MODE) ||
        goog.userAgent.IPAD ||
      ...
      c.play())
    : this.options.parentWorkspace &&
      this.options.parentWorkspace.playAudio(a, b);
};
...
Blockly.Mutator.prototype.createEditor_ = function () {
  ...
  for (
    var a = goog.dom.createDom("xml"), b = 0, c;
    (c = this.quarkNames_[b]);
    b++
  )
    a.appendChild(goog.dom.createDom("block", { type: c }));
  var d = this;
...
Blockly.Mutator.prototype.resizeBubble_ = function () {
  var a = 2 * Blockly.Bubble.BORDER_WIDTH,
    ...
    c = this.workspace_.flyout_.getMetrics_(),
    d;
  d = this.block_.RTL ? -b.x : b.width + b.x;
  b = Math.max(b.height + 3 * a, c.contentHeight + 20);
  d += 3 * a;
  if (
    Math.abs(this.workspaceWidth_ - d) > a ||
    Math.abs(this.workspaceHeight_ - b) > a
  )
    (this.workspaceWidth_ = d),
      (this.workspaceHeight_ = b),
      this.bubble_.setBubbleSize(d + a, b + a),
...
Blockly.Mutator.prototype.setVisible = function (a) {
  if (a != this.isVisible())
    if (a) {
      ...
      c = this.workspace_.flyout_.width_ + a;
      this.block_.RTL && (c = -c);
...
Blockly.Mutator.prototype.workspaceChanged_ = function () {
  ...
  this.rootBlock_.workspace == this.workspace_ &&
    ((a = this.block_.rendered),
    (this.block_.rendered = !1),
    this.block_.compose(this.rootBlock_),
    (this.block_.rendered = a),
    this.block_.initSvg(),
...
Blockly.Warning.prototype.png_ =
...
Blockly.Warning.textToDom_ = function (a) {
  var b = Blockly.createSvgElement(
    "text",
  ...
  a = a.split("\n");
  for (var c = 0; c < a.length; c++) {
    var d = Blockly.createSvgElement(
        "tspan",
...
Blockly.Warning.prototype.setVisible = function (a) {
  if (a != this.isVisible())
    if (a) {
      a = [];
      for (var b in this.text_) a.push(this.text_[b]);
      b = Blockly.Warning.textToDom_(a.join("\n"));
      this.bubble_ = new Blockly.Bubble(
        this.block_.workspace,
        b,
        this.block_.svgPath_,
      ...
      if (this.block_.RTL) {
        ...
        for (var c = 0, d; (d = b.childNodes[c]); c++)
          d.setAttribute("text-anchor", "end"),
            d.setAttribute("x", a + Blockly.Bubble.BORDER_WIDTH);
      }
      this.updateColour();
      b = this.bubble_.getBubbleSize();
      this.bubble_.setBubbleSize(b.width, b.height);
...
Blockly.Warning.prototype.setText = function (a, b) {
  if (void 0 !== b) {
    if (this.text_[b] == a) return;
    this.text_[b] = a;
  } else {
    if (this.text_.default_ == a) return;
    this.text_.default_ = a;
  }
  this.isVisible() && (this.setVisible(!1), this.setVisible(!0));
};
Blockly.Warning.prototype.removeText = function (a) {
  void 0 !== this.text_[a] &&
    (delete this.text_[a],
    0 === Object.keys(this.text_).length ||
    (1 === Object.keys(this.text_).length && !this.text_.default_)
      ? this.dispose()
      : this.isVisible() && (this.setVisible(!1), this.setVisible(!0)));
};
...
Blockly.Block.obtain = function (a, b) {
  ...
  var c = a.rendered ? new Blockly.BlockSvg() : new Blockly.Block();
  c.initialize(a, b);
  return c;
};
...
Blockly.Block.prototype.fill = function (a, b) {
  ...
  if (b) {
    ...
    goog.asserts.assertObject(
      c,
      'Error: "%s" is an unknown language block.',
      b
    );
    goog.mixin(this, c);
  }
...
Blockly.Block.getById = function (a, b) {
  return Blockly.Realtime.isEnabled()
    ? Blockly.Realtime.getBlockById(a)
    : b.getBlockById(a);
};
Blockly.Block.prototype.dispose = function (a, b, c) {
  ...
  this.workspace &&
    !c &&
    (this.workspace.removeTopBlock(this), (this.workspace = null));
  Blockly.selected == this && (Blockly.selected = null);
  for (a = this.childBlocks_.length - 1; 0 <= a; a--)
    this.childBlocks_[a].dispose(!1);
  for (a = 0; (b = this.inputList[a]); a++) b.dispose();
  this.inputList.length = 0;
  b = this.getConnections_(!0);
  for (a = 0; a < b.length; a++)
    (c = b[a]), c.targetConnection && c.disconnect(), b[a].dispose();
  Blockly.Realtime.isEnabled() &&
...
Blockly.Block.prototype.unplug = function (a, b) {
  ...
  if (this.outputConnection)
    ...
    this.previousConnection &&
      ...
      ((c = this.previousConnection.targetConnection), this.setParent(null));
  ...
  b &&
    this.moveBy(
      Blockly.SNAP_RADIUS * (this.RTL ? -1 : 1),
      2 * Blockly.SNAP_RADIUS
    );
};
Blockly.Block.prototype.duplicate_ = function () {
  ...
  b.x = this.RTL ? b.x - Blockly.SNAP_RADIUS : b.x + Blockly.SNAP_RADIUS;
  ...
  if (this.workspace && 0 == Blockly.dragMode_) {
    ...
    if (!a.isInFlyout)
      for (var b = this.getConnections_(!1), c = 0, d; (d = b[c]); c++) {
        d.targetConnection &&
          d.isSuperior() &&
          d.targetBlock().bumpNeighbours_();
        for (
          var e = d.neighbours_(Blockly.SNAP_RADIUS), f = 0, g;
          (g = e[f]);
          f++
        )
          (d.targetConnection && g.targetConnection) ||
            (g.sourceBlock_.getRootBlock() != a &&
...
Blockly.Block.prototype.setParent = function (a) {
  if (this.parentBlock_) {
    ...
    goog.array.contains(this.workspace.getTopBlocks(!1), this) &&
...
Blockly.Block.prototype.setEditable = function (a) {
  ...
  if (this.rendered)
    for (b = this.getIcons(), a = 0; a < b.length; a++) b[a].updateEditable();
};
...
Blockly.Block.prototype.setNextStatement = function (a, b) {
  ...
  a &&
    (void 0 === b && (b = null),
    (this.nextConnection = new Blockly.Connection(
      this,
...
Blockly.Block.prototype.setOutput = function (a, b) {
  ...
  a &&
    ...
    void 0 === b && (b = null),
    (this.outputConnection = new Blockly.Connection(
      this,
...
Blockly.Block.prototype.setInputsInline = function (a) {
  this.inputsInline = a;
  this.rendered &&
    (this.render(), this.bumpNeighbours_(), this.workspace.fireChangeEvent());
};
...
Blockly.Block.prototype.toString = function (a) {
  var b = [];
  if (this.collapsed_)
    b.push(this.getInput("_TEMP_COLLAPSED_INPUT").fieldRow[0].text_);
  else
    for (var c = 0, d; (d = this.inputList[c]); c++) {
      for (var e = 0, f; (f = d.fieldRow[e]); e++) b.push(f.getText());
      d.connection &&
        ((d = d.connection.targetBlock()) ? b.push(d.toString()) : b.push("?"));
    }
...
Blockly.Block.prototype.jsonInit = function (a) {
  goog.asserts.assert(
    void 0 == a.output || void 0 == a.previousStatement,
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
  ...
  goog.asserts.assert(
    f == b.length,
    "Message does not reference all %s arg(s).",
    b.length
  );
  !a.length ||
    ("string" != typeof a[a.length - 1] &&
      0 != a[a.length - 1].type.indexOf("field_")) ||
    ((b = { type: "input_dummy" }), c && (b.align = c), a.push(b));
  c = {
...
Blockly.Block.prototype.moveNumberedInputBefore = function (a, b) {
  ...
  goog.asserts.assert(
    a < this.inputList.length,
    "Input index " + a + " out of bounds."
  );
  goog.asserts.assert(
    b <= this.inputList.length,
    "Reference input " + b + " out of bounds."
  );
  ...
  for (var c = 0, d; (d = this.inputList[c]); c++)
    if (d.name == a) {
      d.connection &&
        ...
        d.connection.targetBlock().setParent(null);
      d.dispose();
...
Blockly.ContextMenu.show = function (a, b, c) {
  ...
  if (b.length) {
    ...
    var g = goog.style.getSize(h),
      e = a.clientX + f.x,
      k = a.clientY + f.y;
    a.clientY + g.height >= b.height && (k -= g.height);
    c
      ? g.width >= a.clientX && (e += g.width)
      : a.clientX + g.width >= b.width && (e -= g.width);
...
Blockly.BlockSvg.prototype.initSvg = function () {
  ...
  this.mutator && this.mutator.createIcon();
  this.updateColour();
  this.updateMovable();
  ...
  goog.isFunction(this.onchange) &&
    !this.eventsInit_ &&
    (this.onchangeWrapper_ = Blockly.bindEvent_(
...
Blockly.BlockSvg.terminateDrag_ = function () {
  Blockly.BlockSvg.onMouseUpWrapper_ &&
    ...
    (Blockly.BlockSvg.onMouseUpWrapper_ = null));
  Blockly.BlockSvg.onMouseMoveWrapper_ &&
  ...
  if (2 == Blockly.dragMode_ && a) {
    ...
    a.workspace &&
      ...
      a.workspace.options.gridOptions.snap &&
      goog.Timer.callOnce(a.snapToGrid_, Blockly.BUMP_DELAY / 2, a);
...
Blockly.BlockSvg.prototype.getHeightWidth = function () {
  var a = this.height,
    ...
    c = this.getNextBlock();
  c &&
    ((c = c.getHeightWidth()), (a += c.height - 4), (b = Math.max(b, c.width)));
...
Blockly.BlockSvg.prototype.setCollapsed = function (a) {
  if (this.collapsed_ != a) {
    ...
    b.length || (b[0] = this);
    if (this.rendered) for (c = 0; (a = b[c]); c++) a.render();
  }
};
Blockly.BlockSvg.prototype.onMouseDown_ = function (a) {
  if (!this.isInFlyout) {
    ...
    if (Blockly.isRightButton(a)) this.showContextMenu_(a);
      ...
      this.startDragMouseY = a.clientY;
      Blockly.dragMode_ = 1;
      Blockly.BlockSvg.onMouseUpWrapper_ = Blockly.bindEvent_(
        document,
        "mouseup",
        this,
        this.onMouseUp_
      );
      Blockly.BlockSvg.onMouseMoveWrapper_ = Blockly.bindEvent_(
        document,
        "mousemove",
        this,
        this.onMouseMove_
  ...
  Blockly.doCommand(function () {
    ...
    if (Blockly.selected && Blockly.highlightedConnection_)
      Blockly.localConnection_.connect(Blockly.highlightedConnection_),
        b.rendered &&
          (Blockly.localConnection_.isSuperior()
            ? Blockly.highlightedConnection_
            : Blockly.localConnection_
          ).sourceBlock_.connectionUiEffect(),
        b.workspace.trashcan && b.workspace.trashcan.close();
    else if (Blockly.selected.isDeletable() && b.workspace.isDeleteArea(a)) {
      var c = b.workspace.trashcan;
      c && goog.Timer.callOnce(c.close, 100, c);
...
Blockly.BlockSvg.prototype.showContextMenu_ = function (a) {
  if (!this.workspace.options.readOnly && this.contextMenu) {
    ...
    if (this.isDeletable() && this.isMovable() && !b.isInFlyout) {
      ...
      this.getDescendants().length > this.workspace.remainingCapacity() &&
        (d.enabled = !1);
      c.push(d);
      this.isEditable() &&
        !this.collapsed_ &&
        ...
        ((d = { enabled: !0 }),
        this.comment
          ? ((d.text = Blockly.Msg.REMOVE_COMMENT),
            (d.callback = function () {
      ...
      if (!this.collapsed_)
        for (d = 1; d < this.inputList.length; d++)
          if (
            this.inputList[d - 1].type != Blockly.NEXT_STATEMENT &&
            this.inputList[d].type != Blockly.NEXT_STATEMENT
          ) {
            var d = { enabled: !0 },
      ...
      d = {
        text:
          1 == d
            ...
            : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(d)),
        enabled: !0,
        callback: function () {
          b.dispose(!0, !0);
        },
    ...
    d = {
      enabled: !(goog.isFunction(this.helpUrl)
        ? !this.helpUrl()
        : !this.helpUrl),
    };
...
Blockly.BlockSvg.prototype.onMouseMove_ = function (a) {
  ...
  Blockly.doCommand(function () {
    if (
      ...
      1 == Blockly.dragMode_ &&
        Math.sqrt(Math.pow(c, 2) + Math.pow(d, 2)) > Blockly.DRAG_RADIUS &&
        ((Blockly.dragMode_ = 2),
        Blockly.longStop_(),
        b.setParent(null),
        b.setDragging_(!0),
        b.workspace.recordDeleteAreas());
      if (2 == Blockly.dragMode_) {
        var e = b.startDragX + c,
          f = b.startDragY + d;
        b.getSvgRoot().setAttribute(
          "transform",
          "translate(" + e + ", " + f + ")"
        );
        for (e = 0; e < b.draggedBubbles_.length; e++)
          (f = b.draggedBubbles_[e]),
            f.bubble.setIconLocation(f.x + c, f.y + d);
        for (
          var f = b.getConnections_(!1),
            g = null,
            h = null,
            k = Blockly.SNAP_RADIUS,
            e = 0;
          e < f.length;
          e++
        ) {
          var l = f[e],
            q = l.closest(k, c, d);
          q.connection && ((g = q.connection), (h = l), (k = q.radius));
        }
        Blockly.highlightedConnection_ &&
          Blockly.highlightedConnection_ != g &&
          (Blockly.highlightedConnection_.unhighlight(),
          (Blockly.highlightedConnection_ = null),
        ...
        g &&
          ...
          (g.highlight(),
          (Blockly.highlightedConnection_ = g),
          (Blockly.localConnection_ = h));
        b.isDeletable() && b.workspace.isDeleteArea(a);
      }
    }
    a.stopPropagation();
  });
...
Blockly.BlockSvg.prototype.dispose = function (a, b, c) {
  ...
  this.unplug(a, !1);
  b && this.rendered && this.disposeUiEffect();
  this.rendered = !1;
  b = this.getIcons();
...
Blockly.BlockSvg.prototype.disposeUiEffect = function () {
  ...
  b.setAttribute(
    "transform",
    "translate(" + b.translateX_ + "," + b.translateY_ + ")"
  );
  this.workspace.options.svg.appendChild(b);
  b.bBox_ = b.getBBox();
  b.startDate_ = new Date();
  Blockly.BlockSvg.disposeUiStep_(b, this.RTL);
};
Blockly.BlockSvg.disposeUiStep_ = function (a, b) {
  var c = (new Date() - a.startDate_) / 150;
  1 < c
    ...
    : (a.setAttribute(
        ...
        "translate(" +
          (a.translateX_ +
            (((b ? -1 : 1) * a.bBox_.width) / 2) * c +
            ", " +
            (a.translateY_ + a.bBox_.height * c)) +
          ") scale(" +
          (1 - c) +
          ")"
      ),
      setTimeout(function () {
        Blockly.BlockSvg.disposeUiStep_(a, b);
      }, 10));
};
Blockly.BlockSvg.prototype.connectionUiEffect = function () {
  ...
  var a = Blockly.getSvgXY_(this.svgGroup_);
  this.outputConnection
    ? ((a.x += this.RTL ? 3 : -3), (a.y += 13))
    : this.previousConnection && ((a.x += this.RTL ? -23 : 23), (a.y += 3));
  a = Blockly.createSvgElement(
    "circle",
    {
      cx: a.x,
      cy: a.y,
...
Blockly.BlockSvg.prototype.updateColour = function () {
  if (!this.disabled) {
    var a = Blockly.makeColour(this.getColour()),
      b = goog.color.hexToRgb(a),
      c = goog.color.lighten(b, 0.3),
      b = goog.color.darken(b, 0.2);
    ...
    c = this.getIcons();
    for (a = 0; a < c.length; a++) c[a].updateColour();
...
Blockly.BlockSvg.prototype.updateDisabled = function () {
  ...
  this.disabled || this.getInheritedDisabled()
    ? a ||
    ...
    : a &&
      ...
      this.updateColour());
  for (var a = this.getChildren(), b = 0, c; (c = a[b]); b++)
    c.updateDisabled();
};
Blockly.BlockSvg.prototype.getCommentText = function () {
  return this.comment
    ? this.comment.getText().replace(/\s+$/, "").replace(/ +\n/g, "\n")
    : "";
};
...
Blockly.BlockSvg.prototype.setWarningText = function (a, b) {
  this.setWarningText.pid_ &&
    (clearTimeout(this.setWarningText.pid_), (this.setWarningText.pid_ = 0));
  if (2 == Blockly.dragMode_) {
    var c = this;
    this.setWarningText.pid_ = setTimeout(function () {
      c.setWarningText.pid_ = 0;
      c.setWarningText(a, b);
    }, 100);
  } else {
    ...
    goog.isString(a)
      ? (this.warning || ((this.warning = new Blockly.Warning(this)), (d = !0)),
        this.warning.setText(a, b))
      : this.warning && void 0 === b
      ? (this.warning.dispose(), (d = !0))
      : this.warning && (this.warning.removeText(b), (d = !0));
...
Blockly.BlockSvg.prototype.setMutator = function (a) {
  ...
  a && ((a.block_ = this), (this.mutator = a), this.rendered && a.createIcon());
};
Blockly.BlockSvg.prototype.setDisabled = function (a) {
  this.disabled != a &&
    (Blockly.BlockSvg.superClass_.setDisabled.call(this, a),
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
  ...
  for (
    ...
    if (m.isVisible()) {
      var p;
      l && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT
        ? (p = c[c.length - 1])
        : ((k = m.type),
          (p = []),
          (p.type =
      ...
      l || q != b.length - 1
        ? !l &&
          ...
          b[q + 1] &&
          b[q + 1].type == Blockly.NEXT_STATEMENT &&
          m.renderHeight--
        : m.renderHeight--;
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function (a, b, c, d) {
  ...
  this.previousConnection &&
    (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15),
    ...
    this.previousConnection.moveTo(
      c.x +
        (this.RTL
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f, g) {
  for (var h, k = 0, l, q, m = 0, p; (p = f[m]); m++) {
    h = Blockly.BlockSvg.SEP_SPACE_X;
    0 == m && (h += this.RTL ? -g : g);
    b.push("M", f.rightEdge - 0.5 + "," + (k + 0.5));
    if (this.isCollapsed()) {
      var n = p[0];
      ...
      b.push("h 8");
      n = p.height - Blockly.BlockSvg.JAGGED_TEETH_HEIGHT;
      a.push("v", n);
      this.RTL &&
        (b.push("v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5"), b.push("v", n - 0.7));
      this.width += Blockly.BlockSvg.JAGGED_TEETH_WIDTH;
    } else if (p.type == Blockly.BlockSvg.INLINE) {
      for (var r = 0; (n = p[r]); r++)
        (l = k + Blockly.BlockSvg.FIELD_HEIGHT),
          p.thicker && (l += Blockly.BlockSvg.INLINE_PADDING_Y),
          (h = this.renderFields_(n.fieldRow, h, l)),
          n.type != Blockly.DUMMY_INPUT &&
            (h += n.renderWidth + Blockly.BlockSvg.SEP_SPACE_X),
          n.type == Blockly.INPUT_VALUE &&
            ...
            this.RTL
              ...
              : (d.push(
                ...
                d.push("l", 0.46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")),
            (l = this.RTL
              ? e.x -
                h -
                Blockly.BlockSvg.TAB_WIDTH +
              ...
              : e.x +
                ...
                n.renderWidth -
                1),
            (q = e.y + k + Blockly.BlockSvg.INLINE_PADDING_Y + 1),
            n.connection.moveTo(l, q),
            n.connection.targetConnection && n.connection.tighten_());
      h = Math.max(h, f.rightEdge);
      this.width = Math.max(this.width, h);
      a.push("H", h);
      b.push("H", h - 0.5);
      a.push("v", p.height);
      this.RTL && b.push("v", p.height - 1);
    } else
      p.type == Blockly.INPUT_VALUE
        ? ((n = p[0]),
          (l = k + Blockly.BlockSvg.FIELD_HEIGHT),
          n.align != Blockly.ALIGN_LEFT &&
            ((r =
              f.rightEdge -
              n.fieldWidth -
              Blockly.BlockSvg.TAB_WIDTH -
            ...
            n.align == Blockly.ALIGN_RIGHT
              ? (h += r)
              : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)),
          this.renderFields_(n.fieldRow, h, l),
          a.push(Blockly.BlockSvg.TAB_PATH_DOWN),
          (r = p.height - Blockly.BlockSvg.TAB_HEIGHT),
          a.push("v", r),
          this.RTL
            ...
            : (b.push(
                "M",
                f.rightEdge - 5 + "," + (k + Blockly.BlockSvg.TAB_HEIGHT - 0.7)
              ),
              b.push("l", 0.46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")),
          (l = e.x + (this.RTL ? -f.rightEdge - 1 : f.rightEdge + 1)),
          (q = e.y + k),
          n.connection.moveTo(l, q),
          n.connection.targetConnection &&
            (n.connection.tighten_(),
            (this.width = Math.max(
              this.width,
              f.rightEdge +
        ...
        : p.type == Blockly.DUMMY_INPUT
        ? ((n = p[0]),
          (l = k + Blockly.BlockSvg.FIELD_HEIGHT),
          n.align != Blockly.ALIGN_LEFT &&
            ((r =
              f.rightEdge - n.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X),
            f.hasValue && (r -= Blockly.BlockSvg.TAB_WIDTH),
            n.align == Blockly.ALIGN_RIGHT
              ? (h += r)
              : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)),
          this.renderFields_(n.fieldRow, h, l),
        ...
        : p.type == Blockly.NEXT_STATEMENT &&
          ((n = p[0]),
          0 == m &&
            (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y),
            this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1),
            (k += Blockly.BlockSvg.SEP_SPACE_Y)),
          (l = k + Blockly.BlockSvg.FIELD_HEIGHT),
          n.align != Blockly.ALIGN_LEFT &&
            ((r =
              f.statementEdge -
            ...
            n.align == Blockly.ALIGN_RIGHT
              ...
              : n.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)),
          this.renderFields_(n.fieldRow, h, l),
          (h = f.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH),
          a.push("H", h),
          a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER),
          a.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS),
          ...
          this.RTL
            ? (b.push(
                ...
                h -
                  ...
                  Blockly.BlockSvg.DISTANCE_45_OUTSIDE +
                  "," +
                  (k + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)
              ),
              b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL),
              b.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS),
              b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL))
            : (b.push(
                "M",
                h -
                  Blockly.BlockSvg.NOTCH_WIDTH +
                  Blockly.BlockSvg.DISTANCE_45_OUTSIDE +
                  "," +
                  (k + p.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)
              ),
              b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR)),
          b.push("H", f.rightEdge - 0.5),
          (l = e.x + (this.RTL ? -h : h + 1)),
          (q = e.y + k + 1),
          n.connection.moveTo(l, q),
          n.connection.targetConnection &&
            (n.connection.tighten_(),
          ...
          m == f.length - 1 || f[m + 1].type == Blockly.NEXT_STATEMENT) &&
          (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y),
          this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1),
          (k += Blockly.BlockSvg.SEP_SPACE_Y));
    k += p.height;
  ...
  f.length ||
    ((k = Blockly.BlockSvg.MIN_BLOCK_Y),
    a.push("V", k),
    this.RTL && b.push("V", k - 1));
  return k;
};
Blockly.BlockSvg.prototype.renderDrawBottom_ = function (a, b, c, d) {
  ...
  this.nextConnection &&
    ...
    this.nextConnection.moveTo(
      this.RTL
        ? c.x - Blockly.BlockSvg.NOTCH_WIDTH
        : c.x + Blockly.BlockSvg.NOTCH_WIDTH,
      c.y + d + 1
    ),
    this.nextConnection.targetConnection && this.nextConnection.tighten_(),
    (this.height += 4));
  this.squareBottomLeftCorner_
    ? (a.push("H 0"), this.RTL || b.push("M", "0.5," + (d - 0.5)))
    : (a.push("H", Blockly.BlockSvg.CORNER_RADIUS),
      a.push(
        "a",
        Blockly.BlockSvg.CORNER_RADIUS +
          "," +
      ...
      this.RTL ||
        (b.push(
          ...
          Blockly.BlockSvg.DISTANCE_45_INSIDE +
            "," +
            (d - Blockly.BlockSvg.DISTANCE_45_INSIDE)
        ),
        b.push(
          "A",
          Blockly.BlockSvg.CORNER_RADIUS -
            ...
            (Blockly.BlockSvg.CORNER_RADIUS - 0.5) +
            " 0 0,1 0.5," +
            (d - Blockly.BlockSvg.CORNER_RADIUS)
        )));
};
Blockly.BlockSvg.prototype.renderDrawLeft_ = function (a, b, c, d) {
  this.outputConnection
    ? (this.outputConnection.moveTo(c.x, c.y),
      ...
      this.RTL
        ? (b.push("M", -0.25 * Blockly.BlockSvg.TAB_WIDTH + ",8.4"),
          b.push("l", -0.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1"))
        : (b.push("V", Blockly.BlockSvg.TAB_HEIGHT - 1.5),
          b.push(
            "m",
          ...
          b.push("m", 0.92 * Blockly.BlockSvg.TAB_WIDTH + ",1 V 0.5 H 1")),
      (this.width += Blockly.BlockSvg.TAB_WIDTH))
    : this.RTL ||
      (this.squareTopLeftCorner_
        ? b.push("V", 0.5)
        : b.push("V", Blockly.BlockSvg.CORNER_RADIUS));
  a.push("z");
};
Blockly.Msg = {};
...
Blockly.FieldTextInput.prototype.showEditor_ = function (a) {
  ...
  if (
    ...
    (a = window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.text_)),
      this.sourceBlock_ &&
        this.changeHandler_ &&
        ((b = this.changeHandler_(a)), void 0 !== b && (a = b)),
    ...
    this.resizeEditor_();
    b || (a.focus(), a.select());
    a.onKeyDownWrapper_ = Blockly.bindEvent_(
      a,
      "keydown",
      this,
      this.onHtmlInputKeyDown_
    );
    a.onKeyUpWrapper_ = Blockly.bindEvent_(
      a,
      "keyup",
      this,
      this.onHtmlInputChange_
    );
    a.onKeyPressWrapper_ = Blockly.bindEvent_(
      a,
      "keypress",
      this,
      this.onHtmlInputChange_
    ...
    a.onWorkspaceChangeWrapper_ = Blockly.bindEvent_(
      b,
      "blocklyWorkspaceChange",
      this,
      this.resizeEditor_
...
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function (a) {
  ...
  13 == a.keyCode
    ...
    : 27 == a.keyCode &&
      (this.setText(b.defaultValue), Blockly.WidgetDiv.hide());
};
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function (a) {
  ...
  27 != a.keyCode &&
    ((a = b.value),
    a !== b.oldValue_
      ? ((b.oldValue_ = a), this.setText(a), this.validate_())
      : goog.userAgent.WEBKIT && this.sourceBlock_.render());
};
Blockly.FieldTextInput.prototype.validate_ = function () {
  ...
  this.sourceBlock_ &&
    this.changeHandler_ &&
    (a = this.changeHandler_(b.value));
  null === a
    ? Blockly.addClass_(b, "blocklyInvalidInput")
    : Blockly.removeClass_(b, "blocklyInvalidInput");
};
  ...
  if (a) {
    ...
    b = function (b) {
      ...
      if (null === e) var f = e;
        ...
        void 0 === e && (e = b),
          (f = Blockly.FieldAngle.angleValidator.call(c, e)),
          void 0 !== f && (f = e);
      return f === b ? void 0 : f;
    };
  } else b = Blockly.FieldAngle.angleValidator;
  Blockly.FieldAngle.superClass_.setChangeHandler(b);
};
...
Blockly.FieldAngle.prototype.showEditor_ = function () {
  ...
  var a = Blockly.WidgetDiv.DIV;
  if (a.firstChild) {
    var a = Blockly.createSvgElement(
        "svg",
        {
    ...
    this.line_ = Blockly.createSvgElement(
      "line",
      {
...
Blockly.FieldAngle.prototype.onMouseMove = function (a) {
  ...
  b = Math.atan(-a / c);
  isNaN(b) ||
    ((b = goog.math.toDegrees(b)),
    0 > c ? (b += 180) : 0 < a && (b += 360),
    Blockly.FieldAngle.ROUND &&
      (b = Math.round(b / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND),
    360 <= b && (b -= 360),
    (b = String(b)),
...
Blockly.FieldCheckbox.prototype.init = function (a) {
  this.sourceBlock_ ||
    (Blockly.FieldCheckbox.superClass_.init.call(this, a),
    (this.checkElement_ = Blockly.createSvgElement(
      "text",
      { class: "blocklyText", x: -3 },
      this.fieldGroup_
    )),
...
Blockly.FieldCheckbox.prototype.setValue = function (a) {
  ...
  this.state_ !== a &&
    ((this.state_ = a),
    this.checkElement_ &&
      (this.checkElement_.style.display = a ? "block" : "none"),
    this.sourceBlock_ &&
      this.sourceBlock_.rendered &&
      this.sourceBlock_.workspace.fireChangeEvent());
};
...
Blockly.FieldColour.prototype.showEditor_ = function () {
  ...
  d.y =
    d.y + f.height + e.height >= b.height + c.y
      ? d.y - (f.height - 1)
      : d.y + (e.height - 1);
  this.sourceBlock_.RTL
    ? ((d.x += e.width), (d.x -= f.width), d.x < c.x && (d.x = c.x))
    : d.x > b.width + c.x - f.width && (d.x = b.width + c.x - f.width);
...
Blockly.FieldColour.widgetDispose_ = function () {
  Blockly.FieldColour.changeEventKey_ &&
...
Blockly.FieldDropdown.prototype.init = function (a) {
  this.sourceBlock_ ||
    ...
    Blockly.FieldDropdown.superClass_.init.call(this, a),
    (a = this.text_),
    (this.text_ = null),
    this.setText(a));
};
Blockly.FieldDropdown.prototype.showEditor_ = function () {
  ...
  for (
    var a = this, b = new goog.ui.Menu(), c = this.getOptions_(), d = 0;
    d < c.length;
    d++
  ) {
    var e = c[d][1],
  ...
  e.y =
    e.y + h.height + f.height >= c.height + d.y
      ? e.y - h.height
      : e.y + f.height;
  this.sourceBlock_.RTL
    ? ((e.x += f.width),
      (e.x += Blockly.FieldDropdown.CHECKMARK_OVERHANG),
      e.x < d.x + h.width && (e.x = d.x + h.width))
    : ((e.x -= Blockly.FieldDropdown.CHECKMARK_OVERHANG),
...
Blockly.FieldImage.prototype.init = function (a) {
  if (!this.sourceBlock_) {
    this.sourceBlock_ = a;
    var b = 6 - Blockly.BlockSvg.FIELD_HEIGHT;
    this.fieldGroup_ = Blockly.createSvgElement("g", {}, null);
    this.imageElement_ = Blockly.createSvgElement(
      "image",
      { height: this.height_ + "px", width: this.width_ + "px", y: b },
      this.fieldGroup_
    );
    this.setValue(this.src_);
    goog.userAgent.GECKO &&
      (this.rectElement_ = Blockly.createSvgElement(
        "rect",
        {
...
Blockly.Variables.flyoutCategory = function (a, b, c, d) {
  var e = Blockly.Variables.allVariables(d.targetWorkspace);
  e.sort(goog.string.caseInsensitiveCompare);
  e.unshift(null);
  for (var f = void 0, g = 0; g < e.length; g++)
    if (e[g] !== f) {
      var h = Blockly.Blocks.variables_get
        ? Blockly.Block.obtain(d, "variables_get")
        : null;
      h && h.initSvg();
      var k = Blockly.Blocks.variables_set
        ? Blockly.Block.obtain(d, "variables_set")
        : null;
      k && k.initSvg();
      null === e[g]
        ? (f = (h || k).getVars()[0])
        : (h && h.setFieldValue(e[g], "VAR"),
          k && k.setFieldValue(e[g], "VAR"));
      k && a.push(k);
      h && a.push(h);
  ...
  if (a) {
    ...
    b = function (b) {
      ...
      if (null === e) var f = e;
        ...
        void 0 === e && (e = b),
          (f = Blockly.FieldVariable.dropdownChange.call(c, e)),
          void 0 !== f && (f = e);
      return f === b ? void 0 : f;
    };
  } else b = Blockly.FieldVariable.dropdownChange;
  Blockly.FieldVariable.superClass_.setChangeHandler(b);
};
    ...
    (this.getValue() ||
      this.setValue(
        Blockly.Variables.generateUniqueName(
          a.isInFlyout ? a.workspace.targetWorkspace : a.workspace
        )
      ),
    Blockly.FieldVariable.superClass_.init.call(this, a));
};
...
Blockly.FieldVariable.dropdownCreate = function () {
  var a =
      this.sourceBlock_ && this.sourceBlock_.workspace
...
Blockly.FieldVariable.dropdownChange = function (a) {
  function b(a, b) {
    ...
    c &&
      ((c = c.replace(/[\s\xa0]+/g, " ").replace(/^ | $/g, "")),
      c == Blockly.Msg.RENAME_VARIABLE || c == Blockly.Msg.NEW_VARIABLE) &&
      (c = null);
    return c;
  }
  ...
  if (a == Blockly.Msg.RENAME_VARIABLE) {
    var d = this.getText();
    (a = b(Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", d), d)) &&
      Blockly.Variables.renameVariable(d, a, c);
    return null;
  }
  if (a == Blockly.Msg.NEW_VARIABLE)
    return (a = b(Blockly.Msg.NEW_VARIABLE_TITLE, ""))
      ? (Blockly.Variables.renameVariable(a, a, c), a)
      : null;
};
  ...
  if (goog.isString(b))
    return (
      this.STATEMENT_PREFIX &&
        (b = this.STATEMENT_PREFIX.replace(/%1/g, "'" + a.id + "'") + b),
      this.scrub_(a, b)
    );
  if (null === b) return "";
...
Blockly.Generator.prototype.addLoopTrap = function (a, b) {
  this.INFINITE_LOOP_TRAP &&
    (a = this.INFINITE_LOOP_TRAP.replace(/%1/g, "'" + b + "'") + a);
  this.STATEMENT_PREFIX &&
    (a += this.prefixLines(
      this.STATEMENT_PREFIX.replace(/%1/g, "'" + b + "'"),
      this.INDENT
    ));
  return a;
};
...
Blockly.Procedures.rename = function (a) {
  ...
  for (
    var b = this.sourceBlock_.workspace.getAllBlocks(), c = 0;
    c < b.length;
    c++
  ) {
...
Blockly.Procedures.flyoutCategory = function (a, b, c, d) {
  function e(e, f) {
    for (var k = 0; k < e.length; k++) {
      ...
      for (var q = [], m = 0; m < e[k][1].length; m++) q[m] = "ARG" + m;
      l.setProcedureParameters(e[k][1], q);
      l.initSvg();
      a.push(l);
      b.push(2 * c);
    }
  ...
  Blockly.Blocks.procedures_defreturn &&
    ((f = Blockly.Block.obtain(d, "procedures_defreturn")),
    f.initSvg(),
    a.push(f),
    b.push(2 * c));
  Blockly.Blocks.procedures_ifreturn &&
    ((f = Blockly.Block.obtain(d, "procedures_ifreturn")),
    f.initSvg(),
    a.push(f),
    b.push(2 * c));
  b.length && (b[b.length - 1] = 3 * c);
  f = Blockly.Procedures.allProcedures(d.targetWorkspace);
...
rtclient.Authorizer = function (a) {
  ...
  this.authButton = document.getElementById(
    rtclient.getOption(a, "authButtonElementId")
  );
  this.authDiv = document.getElementById(
    rtclient.getOption(a, "authDivElementId")
  );
};
...
rtclient.Authorizer.prototype.authorize = function (a) {
  var b = this.clientId,
    ...
    e = function (b) {
      b && !b.error
        ? ((d.authButton.disabled = !0),
          d.fetchUserId(a),
          (d.authDiv.style.display = "none"))
        : ((d.authButton.disabled = !1),
          (d.authButton.onclick = f),
          (d.authDiv.style.display = "block"));
    },
    f = function () {
      gapi.auth.authorize(
        {
...
rtclient.createRealtimeFile = function (a, b, c, d) {
  function e(c) {
    gapi.client.drive.files
      .insert({ resource: { mimeType: b, title: a, parents: [{ id: c }] } })
      .execute(d);
  }
  function f() {
    function a(b) {
      gapi.client.drive.properties
        .insert({
          fileId: "appdata",
          resource: { key: rtclient.FOLDER_KEY, value: b },
        })
        .execute(function (a) {
          e(b);
        });
    ...
    gapi.client.drive.properties
      .get({ fileId: "appdata", propertyKey: rtclient.FOLDER_KEY })
      .execute(function (d) {
        if (d.error) c ? b() : a("root");
        else {
          var f = d.result.value;
          gapi.client.drive.files.get({ fileId: f }).execute(function (a) {
...
rtclient.getFileMetadata = function (a, b) {
  gapi.client.load("drive", "v2", function () {
    gapi.client.drive.files.get({ fileId: a }).execute(b);
  });
};
...
rtclient.RealtimeLoader = function (a) {
  ...
  this.newFileMimeType = rtclient.getOption(
    a,
    "newFileMimeType",
  ...
  this.defaultTitle = rtclient.getOption(
    a,
    "defaultTitle",
    "New Realtime File"
  );
...
rtclient.RealtimeLoader.prototype.redirectTo = function (a, b) {
  ...
  c =
    0 == c.length
      ...
      : window.location.pathname + "#" + c.join("&");
...
rtclient.RealtimeLoader.prototype.handleErrors = function (a) {
  a.type == gapi.drive.realtime.ErrorType.TOKEN_REFRESH_REQUIRED
    ? this.authorizer.authorize()
    : a.type == gapi.drive.realtime.ErrorType.CLIENT_ERROR
    ? (alert("An Error happened: " + a.message), (window.location.href = "/"))
    : a.type == gapi.drive.realtime.ErrorType.NOT_FOUND &&
      (alert(
        "The file was not found. It does not exist or you do not have read access to the file."
      ),
...
rtclient.RealtimeLoader.prototype.createNewFileAndRedirect = function () {
  ...
  rtclient.createRealtimeFile(
    this.defaultTitle,
    this.newFileMimeType,
    this.defaultFolderTitle,
    function (b) {
      b.id
        ? (a.afterCreate && a.afterCreate(b.id),
          a.redirectTo([b.id], a.authorizer.userId))
...
Blockly.Realtime.initializeModel_ = function (a) {
  ...
  Blockly.Realtime.chatBoxElementId_ &&
    a
      ...
      .set(
        Blockly.Realtime.chatBoxElementId_,
        a.createString(Blockly.Realtime.chatBoxInitialText_)
      );
};
...
Blockly.Realtime.addTopBlock = function (a) {
  -1 == Blockly.Realtime.topBlocks_.indexOf(a) &&
    Blockly.Realtime.topBlocks_.push(a);
};
...
Blockly.Realtime.onBlocksMapChange_ = function (a) {
  if (!a.isLocal || Blockly.Realtime.withinUndo_) {
    var b = a.newValue;
    b
      ? Blockly.Realtime.placeBlockOnWorkspace_(b, !a.oldValue)
      : ((b = a.oldValue), Blockly.Realtime.deleteBlock(b));
  }
};
...
Blockly.Realtime.placeBlockOnWorkspace_ = function (a, b) {
  Blockly.Realtime.doWithinSync_(function () {
    ...
    if ((c = Blockly.Xml.domToBlock(Blockly.mainWorkspace, c, !0)))
      b && c.workspace.addTopBlock(c),
        (b || goog.array.contains(Blockly.Realtime.topBlocks_, c)) &&
          Blockly.Realtime.moveBlock_(c);
  });
};
...
Blockly.Realtime.blockChanged = function (a) {
  if (
    a.workspace == Blockly.mainWorkspace &&
    Blockly.Realtime.isEnabled() &&
    !Blockly.Realtime.withinSync
  ) {
    a = a.getRootBlock();
    ...
    if (a.relativeX != b.x || a.relativeY != b.y)
      (a.relativeX = b.x), (a.relativeY = b.y), (c = !0);
...
Blockly.Realtime.onFileLoaded_ = function (a) {
  ...
  Blockly.Realtime.topBlocks_ = Blockly.Realtime.model_
    .getRoot()
    .get("topBlocks");
  Blockly.Realtime.model_
    .getRoot()
    .addEventListener(
...
Blockly.Realtime.afterCreate_ = function (a) {
  ...
  b.execute(function (c) {
    c.error &&
      Blockly.Realtime.getUserDomain(a, function (c) {
        b = gapi.client.drive.permissions.insert({
          fileId: a,
          resource: { type: "domain", role: "writer", value: c, withLink: !0 },
        });
...
Blockly.Realtime.getUserDomain = function (a, b) {
  gapi.client.drive.permissions.list({ fileId: a }).execute(function (a) {
...
Blockly.Realtime.parseOptions_ = function (a) {
  ...
  b &&
    ((Blockly.Realtime.chatBoxElementId_ = rtclient.getOption(b, "elementId")),
    (Blockly.Realtime.chatBoxInitialText_ = rtclient.getOption(
      b,
      "initText",
      Blockly.Msg.CHAT
    )));
  Blockly.Realtime.rtclientOptions_.clientId = rtclient.getOption(
    a,
    "clientId"
  );
...
Blockly.Realtime.startRealtime = function (a, b, c) {
  ...
  Blockly.Realtime.initUi_ = function () {
    ...
    if (Blockly.Realtime.chatBoxElementId_) {
      var b = Blockly.Realtime.model_
          .getRoot()
          .get(Blockly.Realtime.chatBoxElementId_),
        c = document.getElementById(Blockly.Realtime.chatBoxElementId_);
      gapi.drive.realtime.databinding.bindString(b, c);
      c.disabled = !1;
    }
  };
  Blockly.Realtime.realtimeLoader_ = new rtclient.RealtimeLoader(
    Blockly.Realtime.rtclientOptions_
  );
...
Blockly.Realtime.addAuthUi_ = function (a) {
  a.style.background =
    "url(" +
    Blockly.pathToMedia +
    Blockly.Realtime.PROGRESS_URL_ +
...
Blockly.Realtime.updateCollabUi_ = function () {
  if (Blockly.Realtime.collabElementId) {
    ...
    goog.dom.removeChildren(a);
    for (
      var b = Blockly.Realtime.document_.getCollaborators(), c = 0;
      c < b.length;
      c++
    ) {
      var d = b[c],
        e = goog.dom.createDom("img", {
          src:
            d.photoUrl || Blockly.pathToMedia + Blockly.Realtime.ANONYMOUS_URL_,
          alt: d.displayName,
...
Blockly.Realtime.genUid = function (a) {
  ...
  return Blockly.Realtime.blocksMap_.has(b)
    ? Blockly.Realtime.genUid("-" + a)
    : b;
};
Blockly.Flyout = function (a) {
  var b = this;
  a.getMetrics = function () {
    return b.getMetrics_();
  };
  a.setMetrics = function (a) {
    return b.setMetrics_(a);
  };
...
Blockly.Flyout.prototype.init = function (a) {
  ...
  this.eventWrappers_.concat(
    Blockly.bindEvent_(this.svgGroup_, "mousewheel", this, this.wheel_)
  );
  this.eventWrappers_.concat(
    Blockly.bindEvent_(
      this.targetWorkspace_.getCanvas(),
      "blocklyWorkspaceChange",
      this,
...
Blockly.Flyout.prototype.setMetrics_ = function (a) {
  ...
  b &&
    (goog.isNumber(a.y) &&
      (this.workspace_.scrollY = -b.contentHeight * a.y - b.contentTop),
    this.workspace_.translate(0, this.workspace_.scrollY + b.absoluteTop));
};
...
Blockly.Flyout.prototype.hide = function () {
  if (this.isVisible()) {
    ...
    this.reflowWrapper_ &&
      (Blockly.unbindEvent_(this.reflowWrapper_), (this.reflowWrapper_ = null));
  }
};
Blockly.Flyout.prototype.show = function (a) {
  this.hide();
  for (var b = this.workspace_.getTopBlocks(!1), c = 0, d; (d = b[c]); c++)
    d.workspace == this.workspace_ && d.dispose(!1, !1);
  ...
  if (a == Blockly.Variables.NAME_TYPE)
    Blockly.Variables.flyoutCategory(b, g, f, this.workspace_);
  else if (a == Blockly.Procedures.NAME_TYPE)
    Blockly.Procedures.flyoutCategory(b, g, f, this.workspace_);
  else
    for (var h = 0; (d = a[h]); h++)
      d.tagName &&
        "BLOCK" == d.tagName.toUpperCase() &&
        ((d = Blockly.Xml.domToBlock(this.workspace_, d)),
        b.push(d),
        g.push(3 * f));
  a = f;
  for (h = 0; (d = b[h]); h++) {
    ...
    k = d.getSvgRoot();
    e = d.getHeightWidth();
    c = this.RTL ? 0 : f + Blockly.BlockSvg.TAB_WIDTH;
    d.moveBy(c, a);
    a += e.height + g[h];
    e = Blockly.createSvgElement("rect", { "fill-opacity": 0 }, null);
    this.workspace_.getCanvas().insertBefore(e, d.getSvgRoot());
    d.flyoutRect_ = e;
    this.buttons_[h] = e;
    this.autoClose
      ? this.listeners_.push(
          Blockly.bindEvent_(k, "mousedown", null, this.createBlockFunc_(d))
        )
      : this.listeners_.push(
          Blockly.bindEvent_(k, "mousedown", null, this.blockMouseDown_(d))
        );
    this.listeners_.push(Blockly.bindEvent_(k, "mouseover", d, d.addSelect));
    this.listeners_.push(Blockly.bindEvent_(k, "mouseout", d, d.removeSelect));
    this.listeners_.push(
      Blockly.bindEvent_(e, "mousedown", null, this.createBlockFunc_(d))
    );
  ...
  this.listeners_.push(
    Blockly.bindEvent_(this.svgBackground_, "mouseover", this, function (a) {
...
Blockly.Flyout.prototype.reflow = function () {
  for (
    var a = 0,
      b = this.CORNER_RADIUS,
      c = this.workspace_.getTopBlocks(!1),
      d = 0,
      e;
    (e = c[d]);
    d++
...
Blockly.Flyout.prototype.blockMouseDown_ = function (a) {
  ...
  return function (c) {
    Blockly.terminateDrag_();
    Blockly.hideChaff();
    Blockly.isRightButton(c)
      ? a.showContextMenu_(c)
      : (Blockly.removeAllRanges(),
        Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED),
...
Blockly.Flyout.prototype.onMouseMoveBlock_ = function (a) {
  if (
    ...
    Blockly.removeAllRanges();
    var b = a.clientY - Blockly.Flyout.startDownEvent_.clientY;
    Math.sqrt(
      Math.pow(a.clientX - Blockly.Flyout.startDownEvent_.clientX, 2) +
        Math.pow(b, 2)
    ) > Blockly.DRAG_RADIUS &&
...
Blockly.Flyout.prototype.filterForCapacity_ = function () {
  for (
    var a = this.targetWorkspace_.remainingCapacity(),
...
Blockly.Flyout.prototype.getRect = function () {
  var a = Blockly.getSvgXY_(this.svgGroup_).x;
  this.RTL || (a -= 1e7);
  return new goog.math.Rect(a, -1e7, 1e7 + this.width_, this.height_ + 2e7);
};
Blockly.Flyout.terminateDrag_ = function () {
  Blockly.Flyout.onMouseUpWrapper_ &&
...
Blockly.Toolbox.prototype.init = function () {
  ...
  Blockly.bindEvent_(this.HtmlDiv, "mousedown", this, function (a) {
    Blockly.isRightButton(a) || a.target == this.HtmlDiv
      ? Blockly.hideChaff(!1)
      : Blockly.hideChaff(!0);
  });
...
Blockly.Toolbox.prototype.position = function () {
  var a = this.HtmlDiv;
  if (a) {
    var b = this.workspace_.options.svg,
      c = goog.style.getPageOffset(b),
      b = Blockly.svgSize(b);
    a.style.left = this.workspace_.RTL
      ? c.x + b.width - a.offsetWidth + "px"
      : c.x + "px";
        ...
        switch (g.tagName.toUpperCase()) {
          case "CATEGORY":
            ...
            "true" == g.getAttribute("expanded") &&
              (h.blocks.length && c.setSelectedItem(h), h.setExpanded(!0));
            break;
          case "SEP":
            e.add(new Blockly.Toolbox.TreeSeparator());
            break;
          case "BLOCK":
            e.blocks.push(g);
        }
...
Blockly.Toolbox.prototype.getRect = function () {
  var a = this.workspace_.RTL
    ? Blockly.svgSize(this.workspace_.options.svg).width - this.width
    : -1e7;
...
Blockly.Toolbox.TreeControl.prototype.handleTouchEvent_ = function (a) {
  ...
  var b = this.getNodeFromEvent_(a);
  b &&
    a.type === goog.events.EventType.TOUCHSTART &&
    setTimeout(function () {
      b.onMouseDown(a);
    }, 1);
};
Blockly.Toolbox.TreeControl.prototype.createNode = function (a) {
  return new Blockly.Toolbox.TreeNode(
    this.toolbox_,
    a ? goog.html.SafeHtml.htmlEscape(a) : goog.html.SafeHtml.EMPTY,
    this.getConfig(),
    this.getDomHelper()
  );
};
  ...
  if (this.selectedItem_ != a) {
    ...
    a && a.blocks && a.blocks.length
      ? (b.flyout_.show(a.blocks),
        b.lastCategory_ != a.blocks &&
          (b.flyout_.scrollToTop(), (b.lastCategory_ = a.blocks)))
      : b.flyout_.hide();
  }
};
...
Blockly.Css.inject = function (a, b) {
  if (!Blockly.Css.styleSheet_) {
    ...
    Blockly.Css.styleSheet_ = goog.cssom.addCssText(c).sheet;
    Blockly.Css.setCursor(Blockly.Css.Cursor.OPEN);
  }
};
Blockly.Css.setCursor = function (a) {
  if (Blockly.Css.currentCursor_ != a) {
    ...
    var b =
      ...
      a +
      ".cur) " +
      (a == Blockly.Css.Cursor.OPEN ? "8 5" : "7 3") +
      ", auto";
    goog.cssom.replaceCssRule(
      "",
      ".blocklyDraggable {\n  cursor: " + b + ";\n}\n",
      Blockly.Css.styleSheet_,
      0
    );
    for (
      var c = document.getElementsByClassName("blocklyToolboxDiv"), d = 0, e;
      (e = c[d]);
      d++
    )
      e.style.cursor = a == Blockly.Css.Cursor.OPEN ? "" : b;
...
Blockly.inject = function (a, b) {
  ...
  var c = Blockly.parseOptions_(b || {}),
    d,
    e = function () {
      var b = Blockly.createDom_(a, c);
      d = Blockly.createMainWorkspace_(b, c);
      Blockly.init_(d);
      d.markFocused();
      Blockly.bindEvent_(b, "focus", d, d.markFocused);
    };
  if (c.enableRealtime) {
    var f = document.getElementById("realtime");
    f && (f.style.display = "block");
    Blockly.Realtime.startRealtime(e, a, c.realtimeOptions);
  } else e();
  return d;
};
Blockly.parseToolboxTree_ = function (a) {
  a
    ? ("string" != typeof a &&
        "undefined" == typeof XSLTProcessor &&
        (a = a.outerHTML),
...
Blockly.parseOptions_ = function (a) {
  ...
  if (b)
    ...
    (c = Blockly.parseToolboxTree_(a.toolbox)),
      (d = Boolean(c && c.getElementsByTagName("category").length)),
      (e = a.trashcan),
      void 0 === e && (e = d),
      (f = a.collapse),
      void 0 === f && (f = d),
  ...
  void 0 === q && (q = !0);
  var m = a.grid || {};
  m.spacing = m.spacing ? parseFloat(m.spacing) : 0;
  m.colour || (m.colour = "#888");
  m.length = m.length ? parseFloat(m.length) : 1;
  m.snap = 0 < m.spacing && !!m.snap;
  var p = "https://blockly-demo.appspot.com/static/media/";
  a.media ? (p = a.media) : a.path && (p = a.path + "media/");
  var n = !!a.realtime;
  return {
    RTL: !!a.rtl,
    collapse: f,
...
Blockly.createDom_ = function (a, b) {
  ...
  var c = Blockly.createSvgElement(
      "svg",
      {
        xmlns: "http://www.w3.org/2000/svg",
        "xmlns:html": "http://www.w3.org/1999/xhtml",
    ...
    e,
    f;
  e = Blockly.createSvgElement("filter", { id: "blocklyEmboss" }, d);
  Blockly.createSvgElement(
    "feGaussianBlur",
    { in: "SourceAlpha", stdDeviation: 1, result: "blur" },
    e
  );
  f = Blockly.createSvgElement(
    "feSpecularLighting",
    {
      in: "blur",
      surfaceScale: 1,
  ...
  Blockly.createSvgElement("fePointLight", { x: -5e3, y: -1e4, z: 2e4 }, f);
  Blockly.createSvgElement(
    "feComposite",
  ...
  e = Blockly.createSvgElement("filter", { id: "blocklyShadowFilter" }, d);
  Blockly.createSvgElement("feGaussianBlur", { stdDeviation: 2 }, e);
  e = Blockly.createSvgElement(
    "pattern",
    {
  ...
  Blockly.createSvgElement("rect", { width: 10, height: 10, fill: "#aaa" }, e);
  Blockly.createSvgElement(
    "path",
    { d: "M 0 0 L 10 10 M 10 0 L 0 10", stroke: "#cc0" },
    e
  );
  e = b.gridOptions.spacing || 100;
  d = Blockly.createSvgElement(
    "pattern",
    {
  ...
  if (0 < b.gridOptions.length && 0 < b.gridOptions.spacing) {
    e = Math.floor(b.gridOptions.spacing / 2) + 0.5;
    f = e - b.gridOptions.length / 2;
    var g = e + b.gridOptions.length / 2;
    Blockly.createSvgElement(
      "line",
      { x1: f, y1: e, x2: g, y2: e, stroke: b.gridOptions.colour },
      d
    );
    1 < b.gridOptions.length &&
      Blockly.createSvgElement(
        "line",
        { x1: e, y1: f, x2: e, y2: g, stroke: b.gridOptions.colour },
        d
      );
  }
  b.gridPattern = d;
  ...
  b.readOnly ||
    ...
    c.addChangeListener(function () {
      if (0 == Blockly.dragMode_) {
        ...
        if (
          a.contentTop < f ||
          a.contentTop + a.contentHeight > a.viewHeight + f ||
          a.contentLeft < (b.RTL ? a.viewLeft : e) ||
          a.contentLeft + a.contentWidth >
            (b.RTL ? a.viewWidth : a.viewWidth + e)
        )
          for (var g = c.getTopBlocks(!1), h = 0, k; (k = g[h]); h++) {
            ...
            0 > m && k.moveBy(0, m);
            m = 25 + e - l.x - (b.RTL ? 0 : q.width);
            0 < m && k.moveBy(m, 0);
            m = e + a.viewWidth - 25 - l.x + (b.RTL ? q.width : 0);
            0 > m && k.moveBy(m, 0);
          }
      }
    });
...
Blockly.init_ = function (a) {
  var b = a.options;
  Blockly.bindEvent_(a.options.svg, "contextmenu", null, function (a) {
  ...
  if (b.languageTree)
    if (a.toolbox_) a.toolbox_.init(a);
    else if (a.flyout_) {
      a.flyout_.init(a);
      a.flyout_.show(b.languageTree.childNodes);
      a.scrollX = a.flyout_.width_;
      b.RTL && (a.scrollX *= -1);
      var c = "translate(" + a.scrollX + ", 0)";
      a.getCanvas().setAttribute("transform", c);
      a.getBubbleCanvas().setAttribute("transform", c);
    }
  b.hasScrollbars &&
  ...
  if (b.hasSounds) {
    ...
    a.loadAudio_(
      [
        b.pathToMedia + "delete.mp3",
        b.pathToMedia + "delete.ogg",
        b.pathToMedia + "delete.wav",
      ],
      "delete"
    );
    var d = [],
  ...
  if (b in Blockly.bindEvent_.TOUCH_MAP)
    for (
      var e = function (a) {
        ...
        g = 0,
        h;
      (h = Blockly.bindEvent_.TOUCH_MAP[b][g]);
      g++
    )
...
Blockly.getSvgXY_ = function (a) {
  ...
  do {
    var d = Blockly.getRelativeXY_(a),
      ...
      c = c + d.y;
    a = a.parentNode;
  } while (a && "svg" != a.nodeName.toLowerCase());
  return { x: b, y: c };
};
  ...
  for (var c = 0, d = [], e = null, f = 0; f < a.length; f++) {
    ...
    0 == c
      ...
      ? "%" == g
        ? (d.push(g), (c = 0))
        : "0" <= g && "9" >= g
        ? ((c = 2), (e = g), (g = d.join("")) && b.push(g), (d.length = 0))
        : (d.push("%", g), (c = 0))
      : 2 == c &&
        ("0" <= g && "9" >= g
          ? (e += g)
          : (b.push(parseInt(e, 10)), f--, (c = 0)));
  }
  (g = d.join("")) && b.push(g);
  return b;
};
...
Blockly.SPRITE = { width: 64, height: 92, url: "sprites.png" };
    ...
    if (27 == a.keyCode) Blockly.hideChaff();
      ...
      try {
        Blockly.selected &&
          ...
          (Blockly.hideChaff(), Blockly.selected.dispose(!0, !0));
      } finally {
        a.preventDefault();
      }
...
Blockly.hideChaff = function (a) {
  ...
  a ||
    ...
    a.toolbox_ &&
      a.toolbox_.flyout_ &&
      a.toolbox_.flyout_.autoClose &&
      a.toolbox_.clearSelection());
};
Blockly.getMainWorkspaceMetrics_ = function () {
  var a = Blockly.svgSize(this.options.svg);
  ...
  try {
    var d = this.getCanvas().getBBox();
  } catch (e) {
    return null;
  }
  if (this.scrollbar)
    var f = this.RTL ? 0 : Blockly.Scrollbar.scrollbarThickness,
      g = Math.min(
        d.x - b / 2,
        d.x +
          d.width -
          b -
          (this.RTL ? Blockly.Scrollbar.scrollbarThickness : 0) +
          5
      ),
      b = Math.max(d.x + d.width + b / 2, d.x + b + f - 5),
      f = Math.min(d.y - c / 2, d.y + d.height - c + 5),
      c = Math.max(
        d.y + d.height + c / 2,
        d.y + c + Blockly.Scrollbar.scrollbarThickness - 5
      );
  else (g = d.x), (b = g + d.width), (f = d.y), (c = f + d.height);
  d = 0;
  !this.RTL && this.toolbox_ && (d = this.toolbox_.width);
  return {
    viewHeight: a.height,
    viewWidth: a.width,
    contentHeight: c - f,
...
Blockly.setMainWorkspaceMetrics_ = function (a) {
  ...
  this.options.gridPattern &&
    (this.options.gridPattern.setAttribute("x", a),
